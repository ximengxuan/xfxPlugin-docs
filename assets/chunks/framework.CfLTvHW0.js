...
function watchPausable(source, cb, options = {}) {
  ...
  return { stop: stop2, pause, resume, isActive: isActive2 };
}
...
export {
  ...
  onUpdated as D,
  getScrollOffset as E,
  Fragment as F,
  renderList as G,
  resolveComponent as H,
  shallowRef as I,
  onContentUpdated as J,
  ...
  withModifiers as a2,
  useSlots as a3,
  getCurrentScope as a4,
  onScopeDispose as a5,
  toValue as a6,
  ...
  isBuiltInDirective as ao,
  isHTMLTag as ap,
  isSVGTag as aq,
  isMathMLTag as ar,
  isVoidTag as as,
  parseStringStyle as at,
  makeMap as au,
  Vue as av,
  useId as aw,
  toRaw as ax,
  ...
  unrefElement as b5,
  notNullish as b6,
  tryOnScopeDispose as b7,
  computedAsync as b8,
  useSessionStorage as b9,
  useLocalStorage as ba,
  watchDebounced as bb,
  useEventListener as bc,
  escapeRegExp as bd,
