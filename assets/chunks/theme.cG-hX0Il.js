const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CIMVft55.js","assets/chunks/framework.CfLTvHW0.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, c as createElementBlock, r as renderSlot, n as normalizeClass, o as openBlock, a as createTextVNode, t as toDisplayString, u as useRouter, b as useData$1, e as onBeforeMount, f as nextTick, i as isExternal$1, g as treatAsHtml, w as withBase, h as computed, j as createBaseVNode, k as unref, _ as _export_sfc$1, l as ref, m as createCommentVNode, p as createVNode, q as createBlock, s as withCtx, T as Transition, v as isActive, x as useMediaQuery$1, y as watch, z as watchEffect, A as onMounted, B as onUnmounted, C as watchPostEffect, D as onUpdated, E as getScrollOffset, F as Fragment, G as renderList, H as resolveComponent, I as shallowRef, J as onContentUpdated, K as resolveDynamicComponent, L as EXTERNAL_URL_RE, M as useRoute, N as mergeProps, O as inject, P as useWindowSize$1, Q as normalizeStyle, R as onKeyStroke, S as useWindowScroll, U as inBrowser, V as readonly, W as defineAsyncComponent, X as __vitePreload, Y as useScrollLock, Z as provide, $ as toHandlers, a0 as withKeys, a1 as onBeforeUnmount, a2 as withModifiers, a3 as useSlots, a4 as getCurrentScope, a5 as onScopeDispose, a6 as toValue, a7 as getCurrentInstance, a8 as reactive, a9 as isRef, aa as h, ab as extend$1, ac as isString$1, ad as NO, ae as toHandlerKey, af as camelize, ag as isSymbol, ah as capitalize, ai as NOOP, aj as EMPTY_OBJ, ak as isArray$1, al as isObject$2, am as isOn, an as isReservedProp, ao as isBuiltInDirective, ap as isHTMLTag, aq as isSVGTag, ar as isMathMLTag, as as isVoidTag, at as parseStringStyle, au as makeMap, av as Vue, aw as useId, ax as toRaw, ay as createPropsRestProxy, az as shallowReactive, aA as mergeDefaults, aB as withDirectives, aC as vShow, aD as isVNode, aE as render$1, aF as useModel, aG as markRaw, aH as vModelDynamic, aI as vModelText, aJ as mergeModels, aK as TransitionGroup, aL as normalizeProps, aM as guardReactiveProps, aN as createStaticVNode, aO as createSlots, aP as effectScope, aQ as Teleport, aR as createApp, aS as vModelRadio } from "./framework.CfLTvHW0.js";
...
function usePermalink(executeBeforeMountFn = true) {
  ...
  const { site, theme: theme2, localeIndex } = useData$1();
  const { base, cleanUrls } = site.value;
  const { permalinks = {} } = theme2.value;
  ...
  const replaceUrlWhenPermalinkExist = async (href) => {
    ...
    if (permalink) {
      return nextTick(async () => {
        ...
        await ((_a2 = router.onAfterUrlLoad) == null ? void 0 : _a2.call(router, to));
      });
    }
    ...
    } else await ((_a = router.onAfterUrlLoad) == null ? void 0 : _a.call(router, href));
  };
  ...
  const startWatch = () => {
    ...
    router.onBeforeRouteChange = async (href) => {
      const selfResult = await (selfOnBeforeRouteChange == null ? void 0 : selfOnBeforeRouteChange(href));
    ...
    router.onAfterRouteChange = async (href) => {
      ...
      await (selfOnAfterRouteChange == null ? void 0 : selfOnAfterRouteChange(href));
    };
...
function normalizeLink$1(url) {
  ...
  if (isExternal$1(url) || url.startsWith("#") || !protocol.startsWith("http") || !treatAsHtml(pathname))
    return url;
  const { site } = useData();
...
const _hoisted_1$1K = { class: "NotFound" };
const _hoisted_2$1b = { class: "code" };
const _hoisted_3$O = { class: "title" };
const _hoisted_4$B = { class: "quote" };
const _hoisted_5$r = { class: "action" };
const _hoisted_6$l = ["href", "aria-label"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1K, [
        createBaseVNode("p", _hoisted_2$1b, toDisplayString(((_a = unref(theme2).notFound) == null ? void 0 : _a.code) ?? "404"), 1),
        ...
        createBaseVNode("div", _hoisted_5$r, [
          ...
          }, toDisplayString(((_e = unref(theme2).notFound) == null ? void 0 : _e.linkText) ?? "Take me home"), 9, _hoisted_6$l)
        ])
      ]);
    };
  }
});
const NotFound = /* @__PURE__ */ _export_sfc$1(_sfc_main$2w, [["__scopeId", "data-v-d6be1790"]]);
  ...
  setup(__props) {
    ...
    onBeforeMount(async () => {
      ...
      if (filePath) {
        ...
        history.replaceState(history.state || null, "", targetUrl);
        await router.go(targetUrl);
        setTimeout(unDisableNotFoundPage, 3e3);
      } else unDisableNotFoundPage();
    });
    return (_ctx, _cache) => {
      return !disableNotFoundPage.value ? renderSlot(_ctx.$slots, "not-found", { key: 0 }, () => [
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, { name: "fade" }, {
        default: withCtx(() => [
          __props.show ? (openBlock(), createElementBlock("div", _hoisted_1$1J)) : createCommentVNode("", true)
        ]),
        _: 1
      });
    };
...
const VPBackdrop = /* @__PURE__ */ _export_sfc$1(_sfc_main$2u, [["__scopeId", "data-v-c79a1216"]]);
...
const ignoreRE$1 = /\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/;
const resolvedHeaders$1 = [];
function resolveTitle$1(theme2) {
...
function serializeHeader$1(h2) {
  let ret = "";
  for (const node of h2.childNodes) {
    if (node.nodeType === 1) {
      if (ignoreRE$1.test(node.className))
        continue;
...
function buildTree$1(data, min, max) {
...
const _hoisted_1$1I = ["href", "title"];
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.headers, ({ children, link, title }) => {
          return openBlock(), createElementBlock("li", null, [
            createBaseVNode("a", {
              ...
              onClick,
              title
            }, toDisplayString(title), 9, _hoisted_1$1I),
...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$2t, [["__scopeId", "data-v-b933a997"]]);
const _hoisted_1$1H = { class: "content" };
const _hoisted_2$1a = {
  "aria-level": "2",
  class: "outline-title",
...
const _sfc_main$2s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onContentUpdated(() => {
      headers.value = getHeaders$1(frontmatter.value.outline ?? theme2.value.outline);
    });
    const container = ref();
    const marker = ref();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("nav", {
        ...
        createBaseVNode("div", _hoisted_1$1H, [
          ...
          createBaseVNode("div", _hoisted_2$1a, toDisplayString(unref(resolveTitle$1)(unref(theme2))), 1),
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc$1(_sfc_main$2s, [["__scopeId", "data-v-a5bbad30"]]);
const _hoisted_1$1G = { class: "VPDocAsideCarbonAds" };
...
const _hoisted_1$1F = { class: "VPDocAside" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1F, [
        ...
        unref(theme2).carbonAds ? (openBlock(), createBlock(_sfc_main$2r, {
          key: 0,
...
const VPDocAside = /* @__PURE__ */ _export_sfc$1(_sfc_main$2q, [["__scopeId", "data-v-3f215769"]]);
...
function usePrevNext() {
  ...
  return computed(() => {
    ...
    const index2 = candidates.findIndex((link) => {
...
const _hoisted_1$1E = { class: "VPLastUpdated" };
const _hoisted_2$19 = ["datetime"];
const _sfc_main$2o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a;
      return openBlock(), createElementBlock("p", _hoisted_1$1E, [
        ...
        createBaseVNode("time", { datetime: isoDatetime.value }, toDisplayString(datetime.value), 9, _hoisted_2$19)
      ]);
    };
  }
});
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc$1(_sfc_main$2o, [["__scopeId", "data-v-e98dd255"]]);
const _hoisted_1$1D = {
  key: 0,
  class: "VPDocFooter"
};
...
const _hoisted_6$k = { class: "pager" };
const _hoisted_7$d = ["innerHTML"];
const _hoisted_8$9 = ["innerHTML"];
const _hoisted_9$7 = { class: "pager" };
...
const _sfc_main$2n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a, _b, _c, _d;
      return showFooter.value ? (openBlock(), createElementBlock("footer", _hoisted_1$1D, [
        renderSlot(_ctx.$slots, "doc-footer-before", {}, void 0, true),
        hasEditLink.value || hasLastUpdated.value ? (openBlock(), createElementBlock("div", _hoisted_2$18, [
        ...
        ((_a = unref(control).prev) == null ? void 0 : _a.link) || ((_b = unref(control).next) == null ? void 0 : _b.link) ? (openBlock(), createElementBlock("nav", _hoisted_5$q, [
          _cache[1] || (_cache[1] = createBaseVNode("span", {
            class: "visually-hidden",
            id: "doc-footer-aria-label"
          }, "Pager", -1)),
          createBaseVNode("div", _hoisted_6$k, [
            ((_c = unref(control).prev) == null ? void 0 : _c.link) ? (openBlock(), createBlock(_sfc_main$2p, {
              key: 0,
          ...
          createBaseVNode("div", _hoisted_9$7, [
            ((_d = unref(control).next) == null ? void 0 : _d.link) ? (openBlock(), createBlock(_sfc_main$2p, {
              key: 0,
...
const VPDocFooter = /* @__PURE__ */ _export_sfc$1(_sfc_main$2n, [["__scopeId", "data-v-e257564d"]]);
const _hoisted_1$1C = { class: "container" };
const _hoisted_2$17 = { class: "aside-container" };
const _hoisted_3$M = { class: "aside-content" };
const _hoisted_4$z = { class: "content" };
const _hoisted_5$p = { class: "content-container" };
const _hoisted_6$j = { class: "main" };
const _sfc_main$2m = /* @__PURE__ */ defineComponent({
  __name: "VPDoc",
  setup(__props) {
    const { theme: theme2 } = useData();
    const route = useRoute();
    const { hasSidebar, hasAside, leftAside } = useSidebar$1();
        ...
        createBaseVNode("div", _hoisted_1$1C, [
          ...
          createBaseVNode("div", _hoisted_4$z, [
            createBaseVNode("div", _hoisted_5$p, [
              ...
              createBaseVNode("main", _hoisted_6$j, [
...
const VPDoc = /* @__PURE__ */ _export_sfc$1(_sfc_main$2m, [["__scopeId", "data-v-39a288b8"]]);
...
const VPButton = /* @__PURE__ */ _export_sfc$1(_sfc_main$2l, [["__scopeId", "data-v-fa7799d5"]]);
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return __props.image ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        ...
        }), null, 16, _hoisted_1$1B)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
...
const VPImage = /* @__PURE__ */ _export_sfc$1(_sfc_main$2k, [["__scopeId", "data-v-8426fc1a"]]);
const _hoisted_1$1A = { class: "container" };
const _hoisted_2$16 = { class: "main" };
const _hoisted_3$L = { class: "heading" };
const _hoisted_4$y = ["innerHTML"];
...
const _hoisted_9$6 = { class: "image-container" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$1A, [
            ...
            renderSlot(_ctx.$slots, "home-hero-info", {}, () => [
              createBaseVNode("h1", _hoisted_3$L, [
                __props.name ? (openBlock(), createElementBlock("span", {
                  ...
                  class: "name clip"
                }, null, 8, _hoisted_4$y)) : createCommentVNode("", true),
              ...
              __props.tagline ? (openBlock(), createElementBlock("p", {
                ...
                class: "tagline"
              }, null, 8, _hoisted_6$i)) : createCommentVNode("", true)
            ], true),
            renderSlot(_ctx.$slots, "home-hero-info-after", {}, void 0, true),
            __props.actions ? (openBlock(), createElementBlock("div", _hoisted_7$c, [
          ...
          __props.image || unref(heroImageSlotExists) ? (openBlock(), createElementBlock("div", _hoisted_8$8, [
...
const VPHero = /* @__PURE__ */ _export_sfc$1(_sfc_main$2j, [["__scopeId", "data-v-4f9c455b"]]);
...
const _hoisted_5$n = ["innerHTML"];
const _hoisted_6$h = {
  key: 4,
  class: "link-text"
};
const _hoisted_7$b = { class: "link-text-value" };
const _sfc_main$2h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$2p, {
        class: "VPFeature",
        href: __props.link,
        rel: __props.rel,
        ...
        default: withCtx(() => [
          createBaseVNode("article", _hoisted_1$1z, [
            typeof __props.icon === "object" && __props.icon.wrap ? (openBlock(), createElementBlock("div", _hoisted_2$15, [
              createVNode(VPImage, {
                image: __props.icon,
            ...
            __props.linkText ? (openBlock(), createElementBlock("div", _hoisted_6$h, [
...
const VPFeature = /* @__PURE__ */ _export_sfc$1(_sfc_main$2h, [["__scopeId", "data-v-a3976bdc"]]);
const _hoisted_1$1y = {
  key: 0,
  class: "VPFeatures"
};
const _hoisted_2$14 = { class: "container" };
...
const _sfc_main$2g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return __props.features ? (openBlock(), createElementBlock("div", _hoisted_1$1y, [
...
const VPFeatures = /* @__PURE__ */ _export_sfc$1(_sfc_main$2g, [["__scopeId", "data-v-a6181336"]]);
...
const VPHomeContent = /* @__PURE__ */ _export_sfc$1(_sfc_main$2e, [["__scopeId", "data-v-8e2d4988"]]);
...
const VPHome = /* @__PURE__ */ _export_sfc$1(_sfc_main$2d, [["__scopeId", "data-v-8b561e3d"]]);
const _sfc_main$2c = {};
const _hoisted_1$1x = { class: "VPPage" };
...
const VPPage = /* @__PURE__ */ _export_sfc$1(_sfc_main$2c, [["render", _sfc_render$2]]);
...
const VPContent = /* @__PURE__ */ _export_sfc$1(_sfc_main$2b, [["__scopeId", "data-v-1428d186"]]);
const _hoisted_1$1w = { class: "container" };
const _hoisted_2$13 = ["innerHTML"];
    ...
    return (_ctx, _cache) => {
      return unref(theme2).footer && unref(frontmatter).footer !== false ? (openBlock(), createElementBlock("footer", {
        ...
        createBaseVNode("div", _hoisted_1$1w, [
          ...
          }, null, 8, _hoisted_2$13)) : createCommentVNode("", true),
...
const VPFooter = /* @__PURE__ */ _export_sfc$1(_sfc_main$2a, [["__scopeId", "data-v-e315a0ad"]]);
...
const _hoisted_1$1v = { class: "menu-text" };
const _hoisted_2$12 = { class: "header" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.headers.length > 0 ? (openBlock(), createElementBlock("button", {
          ...
          createBaseVNode("span", _hoisted_1$1v, toDisplayString(unref(resolveTitle$1)(unref(theme2))), 1),
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc$1(_sfc_main$29, [["__scopeId", "data-v-8a42e2b4"]]);
const _hoisted_1$1u = { class: "container" };
const _hoisted_2$11 = ["aria-expanded"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(frontmatter).layout !== "home" && (!emptyAndNoSidebar.value || unref(y) >= navHeight.value) ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$1u, [
...
const VPLocalNav = /* @__PURE__ */ _export_sfc$1(_sfc_main$28, [["__scopeId", "data-v-a6f0e41e"]]);
function useNav() {
...
const _hoisted_2$10 = { class: "check" };
const _hoisted_3$F = {
  key: 0,
  class: "icon"
};
function _sfc_render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("button", _hoisted_1$1t, [
    createBaseVNode("span", _hoisted_2$10, [
...
const VPSwitch = /* @__PURE__ */ _export_sfc$1(_sfc_main$27, [["render", _sfc_render$1], ["__scopeId", "data-v-1d5665e3"]]);
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc$1(_sfc_main$26, [["__scopeId", "data-v-5337faa4"]]);
const _hoisted_1$1s = {
  key: 0,
...
const _sfc_main$25 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { site } = useData();
    return (_ctx, _cache) => {
      return unref(site).appearance && unref(site).appearance !== "force-dark" && unref(site).appearance !== "force-auto" ? (openBlock(), createElementBlock("div", _hoisted_1$1s, [
        createVNode(VPSwitchAppearance)
      ])) : createCommentVNode("", true);
    };
  }
});
const VPNavBarAppearance = /* @__PURE__ */ _export_sfc$1(_sfc_main$25, [["__scopeId", "data-v-6c893767"]]);
...
const _hoisted_1$1r = { class: "VPMenuLink" };
...
const VPMenuLink = /* @__PURE__ */ _export_sfc$1(_sfc_main$24, [["__scopeId", "data-v-35975db6"]]);
const _hoisted_1$1q = { class: "VPMenuGroup" };
const _hoisted_2$_ = {
  key: 0,
  class: "title"
};
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1q, [
        __props.text ? (openBlock(), createElementBlock("p", _hoisted_2$_, toDisplayString(__props.text), 1)) : createCommentVNode("", true),
...
const VPMenuGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$23, [["__scopeId", "data-v-69e747b5"]]);
const _hoisted_1$1p = { class: "VPMenu" };
const _hoisted_2$Z = {
  key: 0,
  class: "items"
};
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1p, [
        __props.items ? (openBlock(), createElementBlock("div", _hoisted_2$Z, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.items, (item) => {
...
const VPMenu = /* @__PURE__ */ _export_sfc$1(_sfc_main$22, [["__scopeId", "data-v-b98bc113"]]);
const _hoisted_1$1o = ["aria-expanded", "aria-label"];
const _hoisted_2$Y = {
  key: 0,
  class: "text"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("button", {
          ...
          __props.button || __props.icon ? (openBlock(), createElementBlock("span", _hoisted_2$Y, [
          ...
          ])) : (openBlock(), createElementBlock("span", _hoisted_4$w))
        ], 8, _hoisted_1$1o),
...
const VPFlyout = /* @__PURE__ */ _export_sfc$1(_sfc_main$21, [["__scopeId", "data-v-cf11d7a2"]]);
const _hoisted_1$1n = ["href", "aria-label", "innerHTML"];
...
const VPSocialLink = /* @__PURE__ */ _export_sfc$1(_sfc_main$20, [["__scopeId", "data-v-bd121fe5"]]);
const _hoisted_1$1m = { class: "VPSocialLinks" };
...
const VPSocialLinks = /* @__PURE__ */ _export_sfc$1(_sfc_main$1$, [["__scopeId", "data-v-7bc22406"]]);
const _hoisted_1$1l = {
  key: 0,
  class: "group translations"
};
const _hoisted_2$X = { class: "trans-title" };
const _hoisted_3$D = {
  key: 1,
  class: "group"
};
const _hoisted_4$v = { class: "item appearance" };
const _hoisted_5$l = { class: "label" };
const _hoisted_6$g = { class: "appearance-action" };
const _hoisted_7$a = {
  key: 2,
  class: "group"
};
const _hoisted_8$7 = { class: "item social-links" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return hasExtraContent.value ? (openBlock(), createBlock(VPFlyout, {
        ...
        default: withCtx(() => [
          unref(localeLinks).length && unref(currentLang).label ? (openBlock(), createElementBlock("div", _hoisted_1$1l, [
            createBaseVNode("p", _hoisted_2$X, toDisplayString(unref(currentLang).label), 1),
          ...
          unref(site).appearance && unref(site).appearance !== "force-dark" && unref(site).appearance !== "force-auto" ? (openBlock(), createElementBlock("div", _hoisted_3$D, [
            createBaseVNode("div", _hoisted_4$v, [
              createBaseVNode("p", _hoisted_5$l, toDisplayString(unref(theme2).darkModeSwitchLabel || "Appearance"), 1),
              createBaseVNode("div", _hoisted_6$g, [
                createVNode(VPSwitchAppearance)
              ])
            ])
          ])) : createCommentVNode("", true),
          unref(theme2).socialLinks ? (openBlock(), createElementBlock("div", _hoisted_7$a, [
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc$1(_sfc_main$1_, [["__scopeId", "data-v-bb2aa2f0"]]);
const _hoisted_1$1k = ["aria-expanded"];
...
const VPNavBarHamburger = /* @__PURE__ */ _export_sfc$1(_sfc_main$1Z, [["__scopeId", "data-v-e5dd9c1c"]]);
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc$1(_sfc_main$1Y, [["__scopeId", "data-v-e56f3d57"]]);
...
const _sfc_main$1W = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { theme: theme2 } = useData();
    return (_ctx, _cache) => {
      return unref(theme2).nav ? (openBlock(), createElementBlock("nav", _hoisted_1$1i, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(theme2).nav, (item) => {
          return openBlock(), createElementBlock(Fragment, {
            ...
            "link" in item ? (openBlock(), createBlock(VPNavBarMenuLink, {
              ...
              key: 1,
              ref_for: true
            }, item.props), null, 16)) : (openBlock(), createBlock(_sfc_main$1X, {
              key: 2,
              item
            }, null, 8, ["item"]))
          ], 64);
...
const VPNavBarMenu = /* @__PURE__ */ _export_sfc$1(_sfc_main$1W, [["__scopeId", "data-v-dc692963"]]);
...
const _hoisted_2$W = { class: "DocSearch-Button-Container" };
...
const _hoisted_1$1g = { class: "VPNavBarSearch" };
const _hoisted_2$V = { id: "local-search" };
const _hoisted_3$B = {
  key: 1,
  id: "docsearch"
};
const _sfc_main$1U = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CIMVft55.js"), true ? __vite__mapDeps([0,1]) : void 0));
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1g, [
        unref(provider) === "local" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          ...
          !actuallyLoaded.value ? (openBlock(), createElementBlock("div", _hoisted_3$B, [
            createVNode(_sfc_main$1V, { onClick: load })
          ])) : createCommentVNode("", true)
        ], 64)) : createCommentVNode("", true)
      ]);
    };
...
const VPNavBarSocialLinks = /* @__PURE__ */ _export_sfc$1(_sfc_main$1T, [["__scopeId", "data-v-0394ad82"]]);
const _hoisted_1$1f = ["href", "rel", "target"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("a", {
          ...
          }, null, 8, _hoisted_2$U)) : unref(theme2).siteTitle === void 0 ? (openBlock(), createElementBlock("span", _hoisted_3$A, toDisplayString(unref(site).title), 1)) : createCommentVNode("", true),
...
const VPNavBarTitle = /* @__PURE__ */ _export_sfc$1(_sfc_main$1S, [["__scopeId", "data-v-1168a8e4"]]);
const _hoisted_1$1e = { class: "items" };
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc$1(_sfc_main$1R, [["__scopeId", "data-v-88af2de4"]]);
const _hoisted_1$1d = { class: "wrapper" };
          ...
          createBaseVNode("div", _hoisted_2$S, [
            ...
            createBaseVNode("div", _hoisted_4$u, [
              createBaseVNode("div", _hoisted_5$k, [
                ...
                createVNode(_sfc_main$1U, { class: "search" }),
...
const VPNavBar = /* @__PURE__ */ _export_sfc$1(_sfc_main$1Q, [["__scopeId", "data-v-6aa21345"]]);
const _hoisted_1$1c = {
  key: 0,
  class: "VPNavScreenAppearance"
};
const _hoisted_2$R = { class: "text" };
const _sfc_main$1P = /* @__PURE__ */ defineComponent({
  __name: "VPNavScreenAppearance",
  setup(__props) {
    const { site, theme: theme2 } = useData();
    return (_ctx, _cache) => {
      return unref(site).appearance && unref(site).appearance !== "force-dark" && unref(site).appearance !== "force-auto" ? (openBlock(), createElementBlock("div", _hoisted_1$1c, [
        createBaseVNode("p", _hoisted_2$R, toDisplayString(unref(theme2).darkModeSwitchLabel || "Appearance"), 1),
        createVNode(VPSwitchAppearance)
      ])) : createCommentVNode("", true);
    };
  }
});
const VPNavScreenAppearance = /* @__PURE__ */ _export_sfc$1(_sfc_main$1P, [["__scopeId", "data-v-b44890b2"]]);
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc$1(_sfc_main$1O, [["__scopeId", "data-v-df37e6dd"]]);
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc$1(_sfc_main$1N, [["__scopeId", "data-v-3e9c20e4"]]);
const _hoisted_1$19 = { class: "VPNavScreenMenuGroupSection" };
const _hoisted_2$Q = {
  key: 0,
  class: "title"
};
...
const VPNavScreenMenuGroupSection = /* @__PURE__ */ _export_sfc$1(_sfc_main$1M, [["__scopeId", "data-v-8133b170"]]);
const _hoisted_1$18 = ["aria-controls", "aria-expanded"];
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$1L, [["__scopeId", "data-v-b9ab8c58"]]);
const _hoisted_1$17 = {
  key: 0,
...
const _sfc_main$1K = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { theme: theme2 } = useData();
    return (_ctx, _cache) => {
      return unref(theme2).nav ? (openBlock(), createElementBlock("nav", _hoisted_1$17, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(theme2).nav, (item) => {
          return openBlock(), createElementBlock(Fragment, {
            key: JSON.stringify(item)
          }, [
...
const _hoisted_1$16 = { class: "list" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(localeLinks).length && unref(currentLang).label ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("ul", _hoisted_1$16, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(localeLinks), (locale) => {
...
const VPNavScreenTranslations = /* @__PURE__ */ _export_sfc$1(_sfc_main$1I, [["__scopeId", "data-v-858fe1a4"]]);
const _hoisted_1$15 = { class: "container" };
...
const VPNavScreen = /* @__PURE__ */ _export_sfc$1(_sfc_main$1H, [["__scopeId", "data-v-f2779853"]]);
const _hoisted_1$14 = {
  key: 0,
  class: "VPNav"
};
const _sfc_main$1G = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return hasNavbar.value ? (openBlock(), createElementBlock("header", _hoisted_1$14, [
...
const VPNav = /* @__PURE__ */ _export_sfc$1(_sfc_main$1G, [["__scopeId", "data-v-ae24b3ad"]]);
const _hoisted_1$13 = ["role", "tabindex"];
const _hoisted_2$O = {
  key: 1,
  class: "items"
};
      ...
      return openBlock(), createBlock(resolveDynamicComponent(sectionTag.value), {
        ...
        default: withCtx(() => [
          __props.item.text ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            __props.item.link ? (openBlock(), createBlock(_sfc_main$2p, {
              key: 0,
              tag: linkTag.value,
              class: "link",
              href: __props.item.link,
          ...
          ], 16, _hoisted_1$13)) : createCommentVNode("", true),
          __props.item.items && __props.item.items.length ? (openBlock(), createElementBlock("div", _hoisted_2$O, [
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$1F, [["__scopeId", "data-v-b3fd67f8"]]);
...
const VPSidebarGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$1E, [["__scopeId", "data-v-c40bc020"]]);
const _hoisted_1$12 = {
  class: "nav",
  id: "VPSidebarNav",
...
const _sfc_main$1D = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { sidebarGroups, hasSidebar } = useSidebar$1();
    const props = __props;
    ...
    return (_ctx, _cache) => {
      return unref(hasSidebar) ? (openBlock(), createElementBlock("aside", {
        ...
        createBaseVNode("nav", _hoisted_1$12, [
          _cache[1] || (_cache[1] = createBaseVNode("span", {
            class: "visually-hidden",
...
const VPSidebar = /* @__PURE__ */ _export_sfc$1(_sfc_main$1D, [["__scopeId", "data-v-319d5ca6"]]);
...
const VPSkipLink = /* @__PURE__ */ _export_sfc$1(_sfc_main$1C, [["__scopeId", "data-v-0b0ada53"]]);
...
const Layout = /* @__PURE__ */ _export_sfc$1(_sfc_main$1B, [["__scopeId", "data-v-9a104c51"]]);
const theme = {
  Layout,
  enhanceApp: ({ app }) => {
    app.component("Badge", _sfc_main$2x);
  }
};
...
const useAnchorScroll = () => {
  ...
  const startWatch = () => {
    if (theme2.value.anchorScroll === false) return;
    watch(
      () => currentAnchor.id,
      (val) => {
...
const useNamespace = (block = "", namespaceOverrides) => {
  const finalNamespace = namespaceModule.namespace;
  const b = (blockSuffix) => {
...
const useTeekConfig = () => {
  ...
  const getTeekConfig = (key, defaultValue) => {
    ...
    if (!key) {
      return { ...dv, ...theme2.value, ...frontmatter.value, ...frontmatter.value.tk, ...unref(teekConfigProvide) };
    }
    const valueFromTheme = theme2.value[key];
    ...
    if (isObject$1(valueFromTheme) || isObject$1(valueFromFrontmatter) || isObject$1(valueFromInject)) {
...
const usePagePath = () => {
  ...
  const { localeIndex, site } = useData$1();
...
const useAllPosts = () => {
  const { theme: theme2 } = useData$1();
  const posts = theme2.value.posts;
...
const useWindowTransitionConfig = (condition) => {
  ...
  return computed(() => {
    ...
    return isObject$1(windowTransition) ? (condition == null ? void 0 : condition(windowTransition)) ?? true : windowTransition !== false;
  });
};
const useCommon = () => {
...
function resolveTitle(theme2) {
  return typeof theme2.outline === "object" && !Array.isArray(theme2.outline) && theme2.outline.label || "On this page";
}
function getHeaders(range) {
  const ns2 = useNamespace();
  const headers = [...document.querySelectorAll(`.${ns2.join("article-page")} :where(h1,h2,h3,h4,h5,h6)`)].filter((el) => el.id && el.hasChildNodes()).map((el) => {
    const level = Number(el.tagName[1]);
    return {
      element: el,
...
var _sfc_main$1A = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("aside-outline-item");
    function onClick({ target: el }) {
      const id = el.href.split("#")[1];
      const heading = document.getElementById(decodeURIComponent(id));
      heading == null ? void 0 : heading.focus({ preventScroll: true });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(
        "ul",
        {
          class: normalizeClass([unref(ns2).b(), __props.root ? unref(ns2).is("root") : unref(ns2).is("nested")])
        },
        [
          (openBlock(true), createElementBlock(
            ...
            renderList(__props.headers, ({ children, link, title }) => {
              return openBlock(), createElementBlock("li", { key: link }, [
                createBaseVNode("a", {
                  class: normalizeClass(unref(ns2).m("link")),
                  href: link,
                  onClick,
                  title
...
var _sfc_main$1z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("aside-outline");
    ...
    onMounted(() => {
      var _a;
      if (!((_a = headers.value) == null ? void 0 : _a.length)) headers.value = getHeaders(frontmatter.value.outline ?? theme2.value.outline);
    });
    const container = ref();
    const marker = ref();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        {
          "aria-labelledby": "doc-outline-aria-label",
          class: normalizeClass([unref(ns2).b(), { "has-outline": headers.value.length > 0 }]),
          ref_key: "container",
          ref: container
        },
        [
          createBaseVNode(
            ...
            [
              createBaseVNode(
                "div",
                {
                  class: normalizeClass(unref(ns2).m("marker")),
                  ref_key: "marker",
                  ref: marker
                },
                null,
              ...
              createBaseVNode(
                "div",
                {
                  id: "doc-outline-aria-label",
                  "aria-level": "2",
                  class: normalizeClass(unref(ns2).m("title")),
                  role: "heading"
                },
                toDisplayString(unref(resolveTitle)(unref(theme2))),
                3
                /* TEXT, CLASS */
              ),
...
var _sfc_main$1y = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("article-page");
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns2).b(), unref(ns2).is("aside", __props.aside)])
        },
        [
          __props.aside ? (openBlock(), createElementBlock(
            ...
            {
              key: 0,
              class: normalizeClass(unref(ns2).e("aside"))
            },
            [
              createBaseVNode(
                "div",
                {
                  class: normalizeClass(unref(ns2).e("aside__container"))
                },
                [
          ...
          createBaseVNode(
            "div",
            {
              class: normalizeClass([unref(ns2).join("doc"), { "vp-doc": __props.doc }])
            },
            [
...
var _sfc_main$1x = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("title-tag");
    return (_ctx, _cache) => {
      return __props.text || _ctx.$slots.default ? (openBlock(), createElementBlock(
        "span",
        {
          key: 0,
          class: normalizeClass([unref(ns2).b(), __props.type && unref(ns2).m(__props.type), __props.position && unref(ns2).m(__props.position), __props.size && unref(ns2).m(__props.size)])
        },
        [
          renderSlot(_ctx.$slots, "default", {}, () => [
            createTextVNode(
...
const _hoisted_1$10 = ["href", "aria-label"];
const _hoisted_2$N = ["innerHTML"];
const _hoisted_3$x = ["id", "aria-labelledby"];
const _hoisted_4$s = ["href", "aria-label"];
      ...
      return openBlock(), createElementBlock(
        ...
        [
          !__props.item.children ? (openBlock(), createElementBlock("a", {
            ...
            ((_a = __props.item.frontmatter) == null ? void 0 : _a.titleTag) ? (openBlock(), createBlock(unref(_sfc_main$1x), {
              key: 0,
          ...
          ], 8, _hoisted_1$10)) : __props.item.children.length ? (openBlock(), createElementBlock(
            Fragment,
            { key: 1 },
            [
              createBaseVNode("div", {
                ...
                }, toDisplayString(`${__props.index}. ${__props.item.title}`), 9, _hoisted_5$i)
              ], 10, _hoisted_3$x),
              ...
              ], 10, _hoisted_6$e)) : createCommentVNode("v-if", true)
            ],
            64
            /* STABLE_FRAGMENT */
          )) : createCommentVNode("v-if", true)
...
const _hoisted_4$r = { class: "flx-wrap-between" };
const _hoisted_5$h = { class: "vp-doc" };
var _sfc_main$1v = /* @__PURE__ */ defineComponent({
  ...{ name: "CataloguePage" },
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("catalogue");
    const { t } = useLocale();
    const { theme: theme2, frontmatter } = useData$1();
    const catalogues = computed(() => {
      var _a, _b;
      return (_b = (_a = theme2.value.catalogues) == null ? void 0 : _a.inv[frontmatter.value.path]) == null ? void 0 : _b.catalogues;
    });
    return (_ctx, _cache) => {
      const _component_Content = resolveComponent("Content");
        ...
        default: withCtx(() => [
          ...
          createBaseVNode(
            ...
            [
              ...
              createBaseVNode("ul", _hoisted_4$r, [
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
...
const createDynamicComponent = (template) => {
  ...
  const render2 = new Function("Vue", code)(Vue);
  return defineComponent({ render: render2 });
};
...
var _sfc_main$1u = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("article-title");
    const { t } = useLocale();
    return (_ctx, _cache) => {
      var _a, _b;
      return openBlock(), createElementBlock("span", {
        ...
        __props.post.frontmatter.titleTag && ((_a = __props.titleTagProps) == null ? void 0 : _a.position) === "left" ? (openBlock(), createBlock(unref(_sfc_main$1x), mergeProps({
          key: 0,
        ...
        __props.post.frontmatter.titleTag && ((_b = __props.titleTagProps) == null ? void 0 : _b.position) === "right" ? (openBlock(), createBlock(unref(_sfc_main$1x), mergeProps({
          key: 1,
          text: __props.post.frontmatter.titleTag
        }, __props.titleTagProps, {
          "aria-label": __props.post.frontmatter.titleTag
...
const _hoisted_1$Z = { class: "count" };
const _hoisted_2$K = { class: "vp-doc" };
const _hoisted_3$v = { class: "year" };
...
const _hoisted_8$6 = { class: "date" };
var _sfc_main$1t = /* @__PURE__ */ defineComponent({
  ...{ name: "ArchivesPage" },
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("archives");
    const { t } = useLocale();
    const { frontmatter } = useData$1();
    const posts = usePosts();
      ...
      return openBlock(), createBlock(unref(_sfc_main$1y), {
        ...
        default: withCtx(() => [
          ...
          createBaseVNode(
            "div",
            {
              class: normalizeClass(`${unref(ns2).e("header")} flx-justify-between`)
            },
            [
              createBaseVNode(
                "h1",
          ...
          createBaseVNode(
            "div",
            {
              class: normalizeClass(unref(ns2).e("timeline"))
            },
            [
              (openBlock(true), createElementBlock(
                Fragment,
                  ...
                  return openBlock(), createElementBlock(
                    ...
                    [
                      createBaseVNode(
                        "div",
                        {
                          class: normalizeClass(`${unref(ns2).em("timeline", "year")} flx-justify-between`)
                        },
                        [
                          createBaseVNode(
                            "div",
                      ...
                      createBaseVNode(
                        "div",
                        {
                          class: normalizeClass(unref(ns2).e("timeline__m"))
                        },
                        [
                          (openBlock(true), createElementBlock(
                            Fragment,
                              ...
                              return openBlock(), createElementBlock(
                                ...
                                [
                                  createBaseVNode(
                                    "div",
                                    {
                                      class: normalizeClass(`${unref(ns2).em("timeline__m", "month")} flx-justify-between`)
                                    },
                                    [
                                      createBaseVNode(
                                        "div",
...
const _hoisted_2$J = ["href", "aria-label"];
const _hoisted_3$u = ["id"];
const _hoisted_4$p = ["href", "aria-label"];
const _hoisted_5$f = ["href"];
const _hoisted_6$c = { "aria-describedby": `overview-title` };
const _hoisted_7$8 = ["href", "aria-label"];
var _sfc_main$1s = /* @__PURE__ */ defineComponent({
  ...{ name: "ArticleOverviewPage" },
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("article-overview");
    const { t } = useLocale();
    const posts = usePosts();
    const { localeIndex, site, theme: theme2, frontmatter } = useData$1();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    const eachFileWords = computed(() => {
      var _a;
      return ((_a = theme2.value.docAnalysisInfo) == null ? void 0 : _a.eachFileWords) || [];
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(_sfc_main$1y), {
        ...
        default: withCtx(() => [
          unref(frontmatter).title ? (openBlock(), createElementBlock("h1", _hoisted_1$Y, [
            createTextVNode(
              toDisplayString(unref(frontmatter).title) + " ",
              1
              /* TEXT */
            ...
            renderList(enhancedCategories.value, (item) => {
              return openBlock(), createElementBlock(
                ...
                [
                  ...
                  }, toDisplayString(item.name) + " " + toDisplayString(unref(t)("tk.articleOverview.category")), 9, _hoisted_5$f),
                  createBaseVNode("table", _hoisted_6$c, [
...
var _sfc_main$1r = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("i", { innerHTML: __props.icon }, null, 8, _hoisted_1$X);
    };
  }
});
const _hoisted_1$W = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return __props.iconType === "unicode" ? (openBlock(), createElementBlock(
        ...
        2
        /* CLASS */
      )) : __props.iconType === "symbol" ? (openBlock(), createElementBlock("svg", _hoisted_2$I, [
        createBaseVNode("use", {
  ...
  setup(__props) {
    ...
    const getStyle = () => {
      return {
        ...
        "--icon-color-hover": __props.hoverColor || ns2.cssVar("theme-color")
      };
    };
    ...
    const isSvgIconHtml = computed(() => {
      var _a;
      return isString(__props.icon) && ((_a = __props.icon) == null ? void 0 : _a.includes("<svg"));
    });
    const isFontIcon = computed(() => isString(__props.icon) && fontIconType.value);
    const isComponent2 = computed(
      () => !isString(__props.icon) && (__props.iconType === "component" || isObject$1(__props.icon) && ("setup" in __props.icon || "render" in __props.icon) || typeof __props.icon === "function")
    );
    ...
    return (_ctx, _cache) => {
      return !isFontIcon.value && !isImage.value && !isSvgIconHtml.value ? (openBlock(), createElementBlock(
        ...
        {
          key: 0,
          class: normalizeClass([unref(ns2).b(), unref(ns2).is("hover", __props.hover)]),
        ...
        [
          unref(slot).default ? renderSlot(_ctx.$slots, "default", { key: 0 }) : isComponent2.value ? (openBlock(), createBlock(resolveDynamicComponent(finalIcon.value), {
            key: 1,
            size: __props.size
          }, null, 8, ["size"])) : isIconifyOffline.value ? (openBlock(), createBlock(_sfc_main$1p, {
            key: 2,
            icon: finalIcon.value
          }, null, 8, ["icon"])) : isIconifyOnline.value ? (openBlock(), createBlock(_sfc_main$1o, {
            key: 3,
            icon: finalIcon.value
          }, null, 8, ["icon"])) : isSvgIcon.value ? (openBlock(), createBlock(_sfc_main$1r, {
            key: 4,
            icon: finalIcon.value
        ...
        class: normalizeClass([unref(ns2).b(), unref(ns2).is("hover", __props.hover)]),
        style: normalizeStyle(getStyle())
      }, null, 14, _hoisted_1$V)) : isFontIcon.value && fontIconType.value ? (openBlock(), createBlock(_sfc_main$1q, {
        key: 2,
        icon: finalIcon.value,
        ...
        class: normalizeClass([unref(ns2).b(), unref(ns2).is("hover", __props.hover)]),
        style: normalizeStyle(getStyle())
      }, null, 14, _hoisted_2$H)) : createCommentVNode("v-if", true);
    };
  }
});
...
var _sfc_main$1m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const typeClass = computed(() => {
      ...
      return { [ns2.bm("icon", type2)]: type2 && iconsMap[type2] };
    });
      ...
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => [
          withDirectives(createBaseVNode("div", {
            ...
            class: normalizeClass([
              unref(ns2).b(),
              { [unref(ns2).m(__props.type)]: __props.type },
              unref(ns2).is("center", __props.center),
              unref(ns2).is("closable", __props.showClose),
              unref(ns2).is("plain", __props.plain),
              __props.customClass
            ]),
            ...
            __props.repeatNum > 1 ? (openBlock(), createBlock(unref(_sfc_main$2x), {
              key: 0,
            ...
            iconComponent.value ? (openBlock(), createBlock(unref(_sfc_main$1n), {
              key: 1,
              icon: iconComponent.value,
              class: normalizeClass([unref(ns2).e("icon"), typeClass.value])
            ...
            __props.showClose ? (openBlock(), createBlock(unref(_sfc_main$1n), {
              key: 2,
...
const getLoginStorageKey = () => {
  ...
  const ns2 = useNamespace();
  const siteLoginKey = ns2.storageKey("private", "site", window.location.hostname);
  const pagesLoginKey = ns2.storageKey("private", "pages", window.location.hostname);
  const pageLoginKey = ns2.storageKey("private", "page", window.location.hostname);
  const realmLoginKey = ns2.storageKey("private", "realm", window.location.hostname);
...
const _hoisted_5$e = { class: "flx-space-y-20 login-form" };
const _hoisted_6$b = ["for"];
const _hoisted_7$7 = ["onUpdate:modelValue", "type", "placeholder", "onFocus", "onBlur"];
        ...
        createBaseVNode(
          ...
          [
            ...
            createBaseVNode(
              "div",
              {
                class: normalizeClass(unref(ns2).e("right"))
              },
              [
                createBaseVNode(
                  "div",
                  {
                    class: normalizeClass([unref(ns2).e("right__header"), "flx-center"])
                  },
                  [
                    unref(frontmatter).logo ? (openBlock(), createElementBlock("img", {
                      ...
                      alt: "logo"
                    }, null, 8, _hoisted_3$s)) : createCommentVNode("v-if", true),
                    createBaseVNode(
                      "span",
                      _hoisted_4$o,
                ...
                createBaseVNode("form", _hoisted_5$e, [
                  (openBlock(true), createElementBlock(
                    Fragment,
                    null,
                    renderList(loginForm, (item, key) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode(
                          "div",
                          {
                            class: normalizeClass([unref(ns2).e("right__form"), unref(ns2).is("focus", item.focusModel), unref(ns2).is("error", item.errorModel)])
                          },
                          [
                            ...
                            createBaseVNode("label", {
                              for: "input-" + key,
                              class: "sr-only"
                            }, toDisplayString(item.placeholder), 9, _hoisted_6$b),
                            withDirectives(createBaseVNode("input", {
                              "onUpdate:modelValue": ($event) => item.model = $event,
                              type: item.type,
                              class: normalizeClass(unref(ns2).em("right__form", "control")),
                  ...
                  createBaseVNode(
                    "div",
                    {
                      class: normalizeClass(unref(ns2).e("right__form__btn"))
                    },
                    [
                      createBaseVNode("button", {
                        type: "button",
                        ...
                        createVNode(unref(_sfc_main$1n), { icon: unref(refreshRightIcon) }, null, 8, ["icon"]),
                        createBaseVNode(
                          "span",
                          null,
                      ...
                      createBaseVNode("button", {
                        ...
                        createVNode(unref(_sfc_main$1n), { icon: unref(successFilledIcon) }, null, 8, ["icon"]),
                        createBaseVNode(
                          "span",
                          null,
...
var _sfc_main$1j = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("risk-link");
    const { t } = useLocale();
    const { frontmatter } = useData$1();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns2).b(), unref(ns2).join("center"), "flx-space-y-20"])
        },
        [
          createBaseVNode(
            "div",
            {
              class: normalizeClass([unref(ns2).e("header"), "flx-align-center"])
            },
            [
              unref(frontmatter).logo ? (openBlock(), createElementBlock("img", {
                key: 0,
          ...
          targetLink.value ? (openBlock(), createElementBlock(
            ...
            {
              key: 0,
              class: normalizeClass([unref(ns2).e("link"), "sle"])
            },
            toDisplayString(targetLink.value),
            3
            /* TEXT, CLASS */
          )) : createCommentVNode("v-if", true),
          targetLink.value ? (openBlock(), createElementBlock("div", _hoisted_2$E, [
            createBaseVNode(
              "button",
              {
                class: "btn",
...
var _sfc_main$1h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const ns2 = useNamespace("demo-code");
    const { t } = useLocale();
    const { copy, copied, isSupported } = useClipboard();
    const { frontmatter, isDark } = useData$1();
    const {
      playgroundUrl = "",
      ...
      return openBlock(), createElementBlock(
        ...
        [
          decodedDescription.value ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: normalizeClass(unref(ns2).b("description")),
            innerHTML: decodedDescription.value
          }, null, 10, _hoisted_1$R)) : createCommentVNode("v-if", true),
          effect.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(DemoComponent)), { key: 1 })) : (openBlock(), createElementBlock(
            ...
            [
              createBaseVNode(
                "div",
                {
                  class: normalizeClass(unref(ns2).e("effect"))
                },
                [
              ...
              createBaseVNode(
                ...
                [
                  ...
                  unref(playgroundUrl) ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                    key: 0,
                  ...
                  unref(githubUrl) ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                    key: 1,
              ...
              createVNode(unref(_sfc_main$1i), null, {
                default: withCtx(() => [
                  withDirectives(createBaseVNode("div", {
                    class: normalizeClass(unref(ns2).join("vp-code")),
              ...
              createVNode(Transition, {
                name: unref(ns2).join("fade-linear"),
                persisted: ""
              }, {
                default: withCtx(() => [
                  withDirectives(createBaseVNode(
                    "div",
                    {
                      class: normalizeClass(unref(ns2).e("float-control")),
                      onClick: _cache[1] || (_cache[1] = ($event) => handleToggleSourceVisible(false)),
                      role: "button"
                    },
                    [
                      createVNode(unref(_sfc_main$1n), { icon: unref(caretTopIcon) }, null, 8, ["icon"]),
                      createBaseVNode(
                        "span",
                        null,
...
var _sfc_main$1g = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("fullscreen-wallpaper");
    const { getTeekConfigRef } = useTeekConfig();
    ...
    const handleFullscreenChange = () => {
      ...
      const bannerContentDom = document.querySelector(`.${ns2.join("banner__content")}`);
      const wavesDom = document.querySelector(`.${ns2.join("banner-waves")}`);
      const bodyBgImageMaskDom = document.querySelector(`.${ns2.join("body-bg-image")} .mask`);
      const bannerMaskDom = document.querySelector(`.${ns2.join("banner-bg-image")} .mask`);
      isFullscreen.value = !!document.fullscreenElement;
      const { hideBanner, hideMask } = wallpaperConfig.value;
      const options = [
        { el: htmlDom, executeClass: ns2.b() },
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        __props.prevText ? (openBlock(), createElementBlock(
          ...
          1
          /* TEXT */
        )) : __props.prevIcon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
          key: 1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        __props.nextText ? (openBlock(), createElementBlock(
          ...
          1
          /* TEXT */
        )) : __props.nextIcon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
          key: 1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", {
        ...
        withDirectives(createBaseVNode("input", {
          ...
          class: normalizeClass([unref(ns2).e("input"), unref(ns2).em("input", __props.size)])
...
const _hoisted_1$M = ["aria-current", "aria-label", "tabindex"];
const _hoisted_2$z = ["tabindex", "aria-label"];
const _hoisted_3$r = ["innerHTML"];
const _hoisted_4$n = ["innerHTML"];
const _hoisted_5$d = ["aria-current", "aria-label", "tabindex"];
const _hoisted_6$a = ["tabindex", "aria-label"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          }, " 1 ", 10, _hoisted_1$M)) : createCommentVNode("v-if", true),
          showPrevMore.value ? (openBlock(), createElementBlock("li", {
            ...
            }, null, 8, _hoisted_3$r)) : (openBlock(), createElementBlock("span", {
              key: 1,
              innerHTML: unref(moreFilledIcon)
            }, null, 8, _hoisted_4$n))
          ], 42, _hoisted_2$z)) : createCommentVNode("v-if", true),
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(pagers.value, (pager) => {
              return openBlock(), createElementBlock("li", {
                ...
                tabindex: tabindex.value
              }, toDisplayString(pager), 11, _hoisted_5$d);
            }),
            128
            /* KEYED_FRAGMENT */
          )),
          showNextMore.value ? (openBlock(), createElementBlock("li", {
            ...
            }, null, 8, _hoisted_7$6)) : (openBlock(), createElementBlock("span", {
              key: 1,
              innerHTML: unref(moreFilledIcon)
            }, null, 8, _hoisted_8$4))
          ], 42, _hoisted_6$a)) : createCommentVNode("v-if", true),
          __props.pageCount > 1 ? (openBlock(), createElementBlock("li", {
            ...
            tabindex: tabindex.value
          }, toDisplayString(__props.pageCount), 11, _hoisted_9$4)) : createCommentVNode("v-if", true)
        ],
        34
...
var _sfc_main$1a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const components = computed(() => {
      ...
      const rightWrapperRoot = h("div", { class: ns2.e("right-wrapper") }, rightWrapperChildren);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns2).b(), unref(ns2).is("background", __props.background), unref(ns2).m(__props.size)])
        },
        [
          (openBlock(true), createElementBlock(
            Fragment,
...
const _hoisted_4$m = ["title", "href", "aria-label"];
var _sfc_main$19 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("article-info");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([unref(ns2).b(), __props.scope]),
        role: "group",
            ...
            return openBlock(), createElementBlock(
              ...
              [
                item.show && (item.data || ((_a = item.dataList) == null ? void 0 : _a.length)) ? (openBlock(), createElementBlock("span", {
                  key: 0,
                  class: normalizeClass([unref(ns2).e("item"), { split: __props.split }]),
                  role: "group",
                  "aria-label": item.title
                }, [
                  unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                    key: 0,
                    icon: item.icon,
                  ...
                  item.data ? (openBlock(), createElementBlock("a", {
                    ...
                    renderList(item.dataList, (data, index2) => {
                      return openBlock(), createElementBlock("a", {
                        ...
                        class: normalizeClass([item.class, "hover-color"]),
                        "aria-label": data
                      }, toDisplayString(data), 11, _hoisted_4$m);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
...
const _hoisted_1$K = ["title", "aria-label"];
const _hoisted_2$x = { class: "list flx" };
const _hoisted_3$p = ["href", "aria-label"];
...
const _hoisted_10$2 = ["href", "aria-label"];
...
var _sfc_main$18 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("post-item");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
          ...
          createBaseVNode("div", _hoisted_2$x, [
            createBaseVNode(
              ...
              [
                ...
                createBaseVNode("a", {
                  class: normalizeClass([unref(ns2).e("left__title"), "hover-color", "sle"]),
                  href: unref(postUrl),
                ...
                excerpt.value && unref(postConfig).excerptPosition === "top" ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: normalizeClass(`${unref(ns2).e("left__excerpt")} top`),
                  ...
                  }, toDisplayString(unref(postConfig).moreLabel), 9, _hoisted_6$9)) : createCommentVNode("v-if", true)
                ], 10, _hoisted_4$l)) : createCommentVNode("v-if", true),
                createCommentVNode(" 文章信息 "),
                createBaseVNode("div", {
                  class: normalizeClass(unref(ns2).e("left__footer")),
                  "aria-label": unref(t)("tk.homePost.infoLabel")
                }, [
                  isShowInfo.value ? (openBlock(), createBlock(unref(_sfc_main$19), {
                    key: 0,
                    post: __props.post,
                    scope: "post",
                ...
                excerpt.value && unref(postConfig).excerptPosition === "bottom" ? (openBlock(), createElementBlock("div", {
                  key: 1,
                  class: normalizeClass(`${unref(ns2).e("left__excerpt")} bottom`),
                  "aria-label": unref(t)("tk.homePost.excerptLabel")
                }, [
                  createBaseVNode("div", {
                    class: "excerpt",
                  ...
                  unref(postConfig).showMore ? (openBlock(), createElementBlock("a", {
                    ...
                    href: unref(postUrl),
                    "aria-label": unref(postConfig).moreLabel
                  }, toDisplayString(unref(postConfig).moreLabel), 9, _hoisted_10$2)) : createCommentVNode("v-if", true)
            ...
            createBaseVNode(
              "div",
              {
                class: normalizeClass(`${unref(ns2).e("right")} flx-align-center`)
              },
              [
...
const _hoisted_1$J = ["href", "alt"];
const _hoisted_2$w = ["src"];
const _hoisted_3$o = ["href", "aria-label"];
const _hoisted_4$k = ["innerHTML", "aria-label"];
var _sfc_main$17 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("post-item-card");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    const postConfig = getTeekConfigRef("post", {
      showCapture: false,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          !!__props.post.frontmatter.sticky ? (openBlock(), createBlock(unref(_sfc_main$1n), {
            key: 0,
            icon: unref(topIcon),
            class: "top",
            size: 40,
          ...
          imgSrcList.value.length ? (openBlock(), createElementBlock(
            ...
            {
              key: 1,
              class: normalizeClass(unref(ns2).e("cover-img"))
            },
            [
              createBaseVNode("a", {
                href: unref(postUrl),
          ...
          createBaseVNode(
            "div",
            {
              class: normalizeClass([unref(ns2).e("info")])
            },
            [
              createBaseVNode("a", {
...
var _sfc_main$16 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(__props, { expose: __expose }) {
    const ns2 = useNamespace("post-list");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    const posts = usePosts();
    const { frontmatter } = useData$1();
    const postConfig = getTeekConfigRef("post", {
      ...
      transition: true,
      transitionName: ns2.join("slide-fade")
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns2).b(), unref(ns2).is("card", unref(postConfig).postStyle === "card")])
        },
        [
          currentPosts.value ? (openBlock(), createElementBlock(
            ...
            [
                        ...
                        return openBlock(), createElementBlock(
                          ...
                          [
                            unref(windowTransition) ? (openBlock(), createElementBlock(
                              ...
                              [
                                unref(postConfig).postStyle === "card" ? (openBlock(), createBlock(_sfc_main$17, {
                                  key: 0,
                                  post
                                }, null, 8, ["post"])) : (openBlock(), createBlock(_sfc_main$18, {
                                  key: 1,
                                  post,
              ...
              createBaseVNode("div", {
                class: normalizeClass(`${unref(ns2).e("pagination")} flx-justify-center`),
            ...
            key: 1,
            class: normalizeClass([unref(ns2).e("empty"), "flx-column-center"]),
            "aria-label": unref(postConfig).emptyLabel
          }, [
            createVNode(unref(_sfc_main$1n), {
              icon: unref(emptyIcon$1),
              size: 160,
            ...
            createBaseVNode(
              "span",
              {
                class: normalizeClass(unref(ns2).e("empty__title"))
              },
...
var _sfc_main$15 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("banner-bg-pure");
    const { t } = useLocale();
    const { getTeekConfig } = useTeekConfig();
    const getStyle = () => {
...
var _sfc_main$14 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("banner-bg-image");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    const getStyle = () => {
      ...
      const imgBgVar = ns2.cssVarName("banner-img-bg");
      const maskBgColorVar = ns2.cssVarName("banner-mask-bg-color");
      const imgSwitchIntervalVar = ns2.cssVarName("banner-img-switch-interval-s");
      if (!(imgSrc == null ? void 0 : imgSrc.length)) return { [imgBgVar]: ns2.cssVar("bg-img-default") };
      return {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          createBaseVNode("div", {
            class: normalizeClass([unref(ns2).b(), { part: isPartImgBgStyle.value, full: isFullImgBgStyle.value }]),
            style: normalizeStyle(getStyle()),
...
var _sfc_main$13 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    var _a;
    const ns2 = useNamespace("banner-content");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
      ...
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.$slots["teek-home-banner-name"] ? renderSlot(_ctx.$slots, "teek-home-banner-name", normalizeProps(mergeProps({ key: 0 }, { name: unref(bannerConfig).name }))) : (openBlock(), createElementBlock(
          ...
          [
            ...
            }, toDisplayString(unref(bannerConfig).name), 11, _hoisted_2$t)
          ],
          2112
          /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */
        )),
        createBaseVNode("p", {
          class: normalizeClass(unref(ns2).e("desc")),
          ...
          isDefaultDescStyle.value ? (openBlock(), createElementBlock(
            ...
            default: withCtx(() => [
              ...
              }, toDisplayString(unref(text) || descArray.value[0]), 9, _hoisted_5$b))
            ]),
            _: 1
            /* STABLE */
            ...
            [
              ...
              }, toDisplayString(unref(typesText)), 9, _hoisted_6$8),
              createBaseVNode(
                "span",
                {
...
const _hoisted_2$s = ["src", "alt", "aria-label"];
const _hoisted_3$m = ["id"];
const _hoisted_4$i = { class: "feature-details" };
var _sfc_main$12 = /* @__PURE__ */ defineComponent({
  ...{ name: "HomeBannerFeature" },
  __name: "HomeBannerFeature",
  setup(__props) {
    var _a;
    const ns2 = useNamespace("banner-feature");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    const { frontmatter } = useData$1();
    const bannerConfig = getTeekConfigRef("banner", {
    ...
    useWindowSize((width) => {
      ...
      if (width <= 719) {
        ...
        clearTimer();
        timer = setInterval(() => {
          active2.value = (active2.value + 1) % features.value.length;
        }, featureCarousel);
      } else {
    ...
    return (_ctx, _cache) => {
      return features.value.length ? (openBlock(), createBlock(TransitionGroup, {
        key: 0,
        name: unref(ns2).join("slide-next"),
        tag: "div",
        class: normalizeClass([unref(ns2).b(), unref(ns2).join("wallpaper-outside"), "flx-wrap-between"]),
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(unref(bannerConfig).features, (feature, index2) => {
              return withDirectives((openBlock(), createElementBlock("div", {
                class: normalizeClass(unref(ns2).e("feature__item")),
                key: index2,
                role: "group",
                ...
                (openBlock(), createBlock(resolveDynamicComponent(feature.link ? "a" : "div"), {
                  ...
                  default: withCtx(() => [
                    feature.image ? (openBlock(), createElementBlock("img", {
                      ...
                      alt: feature.title,
                      "aria-label": feature.title
                    }, null, 8, _hoisted_2$s)) : createCommentVNode("v-if", true),
                    createBaseVNode("p", {
                      id: `feature-title-${index2}`,
                      class: "feature-title"
                    }, toDisplayString(feature.title), 9, _hoisted_3$m),
                    createBaseVNode(
                      "p",
                      _hoisted_4$i,
                ...
                [vShow, !isMobile.value || active2.value === index2]
              ]);
            }),
            128
            /* KEYED_FRAGMENT */
...
var _sfc_main$11 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("banner-waves");
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "svg",
        {
...
var _sfc_main$10 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getStyle = () => {
      const titleTextVar = ns2.cssVarName("banner-title-text");
      const descTextVar = ns2.cssVarName("banner-desc-text");
      const textColorVar = ns2.cssVarName("banner-text-color");
    ...
    const className = computed(() => {
      ...
      if (isBodyPartImgBgStyle) return ns2.is("part-img");
      if (isBodyFullImgBgStyle) return ns2.is("full-img");
      if (isBannerPureBgStyle) return ns2.is("pure");
      if (isBannerPartImgBgStyle) return ns2.is("part-img");
      if (isBannerFullImgBgStyle) return ns2.is("full-img");
      return "";
    });
    const styleComponentMap = {
      bodyPart: { el: "div", props: { class: `body-pure` } },
      bodyFull: { el: "div", props: { class: `body-full` } },
      bannerPure: { el: _sfc_main$15 },
      bannerPartImg: { el: _sfc_main$14 },
      bannerFullImg: { el: _sfc_main$14 }
    };
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          createBaseVNode("div", {
            ref_key: "bannerRef",
            ref: bannerRef,
            class: normalizeClass([unref(ns2).b(), className.value]),
            style: normalizeStyle(getStyle()),
              ...
              normalizeProps(guardReactiveProps(styleComponent.value.props)),
              {
                default: withCtx(() => [
                  createBaseVNode(
                    "div",
                    {
                      class: normalizeClass([unref(ns2).e("content"), { "no-feature": !unref(bannerConfig).features.length }])
                    },
                    [
            ...
            unref(bannerConfig).imgWaves && currentBgStyle.value.isBannerFullImgBgStyle && !currentBgStyle.value.isBodyImgBgStyle ? (openBlock(), createBlock(_sfc_main$11, {
              key: 0,
...
const _hoisted_2$r = ["href", "target", "aria-label"];
...
var _sfc_main$$ = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const ns2 = useNamespace("page-card");
    const pointClass = ns2.join("pointer");
    const { t } = useLocale();
    const emit = __emit;
    ...
    const transitionName2 = ref(ns2.join("scroll"));
    const pagination = (to, type2) => {
      emit("pagination", to, type2);
      transitionName2.value = ns2.join(`slide-${type2}`);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(`${unref(ns2).b()} card`),
        ...
        __props.title ? (openBlock(), createElementBlock(
          ...
          [
            renderSlot(_ctx.$slots, "title", {}, () => [
              ...
              ], 8, _hoisted_2$r)) : __props.titleClick ? (openBlock(), createElementBlock("a", {
                key: 1,
              ...
              ], 10, _hoisted_4$h)) : (openBlock(), createElementBlock("span", {
                key: 2,
                class: "title flx-align-center",
                innerHTML: __props.title
              }, null, 8, _hoisted_6$7))
            ...
            renderSlot(_ctx.$slots, "page", normalizeProps(guardReactiveProps({ pagination })), () => [
              __props.page ? (openBlock(), createElementBlock("div", _hoisted_7$4, [
...
const _hoisted_1$B = ["src", "alt", "srcSet"];
const _hoisted_2$q = { key: 2 };
var _sfc_main$_ = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const avatarClass = computed(() => {
      ...
      if (isString(__props.size)) classList.push(ns2.m(__props.size));
      if (__props.icon) classList.push(ns2.m("icon"));
      if (__props.shape) classList.push(ns2.m(__props.shape));
      return classList;
    });
    const avatarStyle = computed(() => {
      return {
        [ns2.cssVarName("avatar-size")]: addUnit(__props.size),
        [ns2.cssVarName("avatar-bg-color")]: __props.bgColor,
        [ns2.cssVarName("avatar-text-color")]: __props.textColor,
        [ns2.cssVarName("avatar-text-size")]: addUnit(__props.textSize),
        [ns2.cssVarName("avatar-icon-size")]: addUnit(__props.iconSize)
      };
    });
      ...
      return openBlock(), createElementBlock(
        ...
        [
          (__props.src || __props.srcSet) && !hasLoadError.value ? (openBlock(), createElementBlock("img", {
            ...
            onError: handleError
          }, null, 44, _hoisted_1$B)) : __props.icon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
            key: 1,
            icon: __props.icon
...
const _hoisted_2$p = ["href", "title", "aria-label"];
const _hoisted_3$k = ["aria-label"];
const _hoisted_4$g = { class: "name" };
const _hoisted_5$9 = { class: "slogan" };
var _sfc_main$Z = /* @__PURE__ */ defineComponent({
  ...{ name: "HomeMyCard" },
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("my");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    return (_ctx, _cache) => {
      return unref(bloggerConfig).name ? (openBlock(), createBlock(unref(_sfc_main$$), {
        key: 0,
        class: normalizeClass([unref(ns2).b(), unref(ns2).is("circle-bg", isCircleBgImg.value)]),
        ...
        default: withCtx(() => {
          ...
          return [
            isCircleBgImg.value ? (openBlock(), createElementBlock(
              ...
              {
                key: 0,
                class: normalizeClass([unref(ns2).em("avatar__circle", "bg"), unref(ns2).is("mask", unref(bloggerConfig).circleBgMask)]),
            ...
            createBaseVNode(
              "div",
              {
                class: normalizeClass(`${unref(ns2).e("avatar")} ${unref(bloggerConfig).shape} flx-center`)
              },
              [
                createBaseVNode("div", null, [
                  unref(bloggerConfig).avatar ? (openBlock(), createBlock(unref(_sfc_main$_), {
                    key: 0,
                    ...
                    "aria-hidden": "true"
                  }, null, 8, ["src", "size", "shape", "alt", "title"])) : (openBlock(), createBlock(unref(_sfc_main$_), {
                    key: 1,
                    size: unref(bloggerConfig).circleSize ?? 100,
                    shape: shape.value,
                    text: unref(bloggerConfig).name,
                    "text-size": 50,
                    "bg-color": unref(ns2).cssVar("theme-color"),
                    "aria-hidden": "true"
                  }, null, 8, ["size", "shape", "text", "bg-color"])),
                  ((_a = unref(bloggerConfig).status) == null ? void 0 : _a.icon) && ((_b = shape.value) == null ? void 0 : _b.startsWith("circle")) ? (openBlock(), createBlock(unref(_sfc_main$_), {
                    key: 2,
            ...
            unref(socialConfig).length ? (openBlock(), createElementBlock("div", {
              key: 1,
              class: normalizeClass(`${unref(ns2).e("icons")} flx-justify-around`),
              ...
              (openBlock(true), createElementBlock(
                ...
                renderList(unref(socialConfig), (item, index2) => {
                  return openBlock(), createElementBlock("a", {
                    ...
                    item.icon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                      key: 0,
            ...
            createBaseVNode("div", {
              class: normalizeClass(unref(ns2).e("blogger")),
...
const _hoisted_3$j = { class: "date" };
const _hoisted_4$f = ["aria-label"];
var _sfc_main$Y = /* @__PURE__ */ defineComponent({
  ...{ name: "HomeTopArticleCard" },
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("top-article");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    const posts = usePosts();
    ...
    const getStyle = (num, index2) => {
      var _a, _b;
      return {
        [ns2.cssVarName("num-bg-color")]: tagColor.value[num % tagColor.value.length].text,
        top: `calc(${index2} * (calc(${ns2.cssVar("home-top-article-gap")} + ${((_b = (_a = itemRefs.value) == null ? void 0 : _a[index2]) == null ? void 0 : _b.getBoundingClientRect().height) || 0}px)))`
      };
    };
    const router = useRouter();
      ...
      return openBlock(), createBlock(unref(_sfc_main$$), {
        ...
        default: withCtx(({ transitionName: transitionName2 }) => [
          topArticleList.value.length ? (openBlock(), createBlock(TransitionGroup, {
            ...
            tag: "ul",
            mode: "out-in",
            class: normalizeClass(`${unref(ns2).e("list")} flx-column`),
              ...
              (openBlock(true), createElementBlock(
                ...
                renderList(currentTopArticleList.value, (item, index2) => {
                  return openBlock(), createElementBlock("li", {
                    ...
                    ref: itemRefs,
                    key: item.num,
                    class: normalizeClass(unref(ns2).e("list__item")),
                    ...
                    createBaseVNode(
                      "div",
                      {
                        class: normalizeClass(unref(ns2).e("list__item__info"))
                      },
                      [
                        createBaseVNode("a", {
                          href: item.url && unref(withBase)(item.url),
            ...
            key: 1,
            class: normalizeClass(unref(ns2).m("empty")),
            "aria-label": unref(topArticleConfig).emptyLabel
          }, toDisplayString(unref(topArticleConfig).emptyLabel), 11, _hoisted_4$f))
        ]),
        _: 1
        /* STABLE */
...
const _hoisted_1$y = ["onClick", "aria-label"];
const _hoisted_2$n = { class: "sle" };
const _hoisted_3$i = ["href", "aria-label"];
...
var _sfc_main$X = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("category");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$$), {
        ...
        class: normalizeClass([unref(ns2).b(), unref(ns2).is("page", __props.categoriesPage)]),
        ...
        default: withCtx(({ transitionName: transitionName2 }) => [
          categories.value.length ? (openBlock(), createBlock(TransitionGroup, {
            ...
            default: withCtx(() => [
              ...
              }, toDisplayString(unref(categoryConfig).moreLabel), 9, _hoisted_3$i)) : createCommentVNode("v-if", true)
            ]),
            _: 1
            /* STABLE */
          }, 8, ["name", "class", "aria-label"])) : (openBlock(), createElementBlock("div", {
          ...
          }, toDisplayString(unref(categoryConfig).emptyLabel), 11, _hoisted_4$e))
        ]),
        _: 1
        /* STABLE */
...
const _hoisted_1$x = ["onClick", "aria-label"];
const _hoisted_2$m = { class: "num" };
...
var _sfc_main$W = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getTagStyle = (index2) => {
      ...
      return {
        [ns2.cssVarName("home-tag-bg-color")]: color.bg,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$$), {
        ...
        class: normalizeClass([unref(ns2).b(), unref(ns2).is("page", __props.tagsPage)]),
        ...
        default: withCtx(({ transitionName: transitionName2 }) => [
          tags.value.length ? (openBlock(), createBlock(TransitionGroup, {
            ...
            tag: "div",
            mode: "out-in",
            class: normalizeClass(unref(ns2).e("list")),
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(
                ...
                renderList(currentTags.value, (item, index2) => {
                  return openBlock(), createElementBlock("a", {
                    ...
                    class: normalizeClass([{ active: item.name === selectedTag.value }, unref(ns2).join("pointer")]),
                    "aria-label": item.name
                  }, [
                    createBaseVNode(
                      "span",
              ...
              }, toDisplayString(unref(tagConfig).moreLabel), 9, _hoisted_3$h)) : createCommentVNode("v-if", true)
            ]),
            _: 1
            /* STABLE */
          }, 8, ["name", "class", "aria-label"])) : (openBlock(), createElementBlock("div", {
          ...
          }, toDisplayString(unref(tagConfig).emptyLabel), 11, _hoisted_4$d))
        ]),
        _: 1
        /* STABLE */
      }, 8, ["page", "modelValue", "pageSize", "total", "title", "autoPage", "pageSpeed", "class", "aria-label"]);
...
const _hoisted_1$w = ["href", "aria-label"];
const _hoisted_2$l = { class: "friend-avatar skeleton-image" };
      ...
      return openBlock(), createElementBlock("a", {
        ...
        createBaseVNode(
          ...
          [
            ...
            }, toDisplayString(__props.item.name), 9, _hoisted_4$c),
            createBaseVNode("div", {
              class: "friend-desc sle",
              title: __props.item.desc
            }, toDisplayString(__props.item.desc), 9, _hoisted_5$8)
          ],
          2
          /* CLASS */
        )
...
var _sfc_main$U = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("friend-link");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    const getLiStyle = (index2) => {
      ...
      return {
        top: `calc(${index2} * (calc(${ns2.cssVar("home-friend-link-gap")} + ${(clientRect == null ? void 0 : clientRect.height) || 0}px)))`
      };
    };
    const router = useRouter();
    const handleTitleClick = () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$$), {
        ...
        default: withCtx(({ transitionName: transitionName2, startAutoPage, closeAutoPage }) => [
          ...
          }, toDisplayString(unref(friendLinkConfig).emptyLabel), 11, _hoisted_1$v))
        ]),
        _: 1
        /* STABLE */
...
var _sfc_main$T = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("doc-analysis");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    const { theme: theme2 } = useData$1();
    ...
    const docAnalysisInfo = computed(() => theme2.value.docAnalysisInfo || {});
    const finalTitle = computed(() => {
    ...
    const docAnalysisList = computed(() => {
      ...
      const list = [
        ...
        },
        {
          ...
          originValue: (_a = postAddNum.value) == null ? void 0 : _a.weekAddNum,
...
var _sfc_main$S = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("home-card-list");
    const { getTeekConfigRef } = useTeekConfig();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns2).b(), "flx-column"])
        },
        [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(isHomePage) && (unref(teekConfig).banner.enabled ?? true) ? withDirectives((openBlock(), createElementBlock(
          ...
          _hoisted_2$j,
          [
            createVNode(unref(_sfc_main$10), { disabled: isPaging.value }, createSlots({
              _: 2
              /* DYNAMIC */
            }, [
              renderList(_ctx.$slots, (_, name) => {
        ...
        createBaseVNode(
          "div",
          {
            class: normalizeClass([unref(ns2).e("content"), unref(ns2).join("wallpaper-outside"), "flx-start-justify-center"])
          },
          [
            createBaseVNode("div", {
              class: normalizeClass(unref(ns2).e("content__post")),
            ...
            unref(teekConfig).homeCardListPosition ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: normalizeClass([unref(ns2).e("content__info"), unref(teekConfig).homeCardListPosition === "left" ? unref(ns2).is("left") : unref(ns2).is("right")]),
        ...
        unref(teekConfig).wallpaper.enabled && (unref(teekConfig).banner.bgStyle === "fullImg" || unref(teekConfig).bodyBgImg.imgSrc) ? (openBlock(), createBlock(unref(_sfc_main$1g), { key: 1 })) : createCommentVNode("v-if", true)
      ], 10, _hoisted_1$t);
    };
  }
});
...
var _sfc_main$Q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("my-screen");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
            ...
            createBaseVNode(
              ...
              [
                createBaseVNode(
                  "div",
                  {
                    class: normalizeClass(unref(ns2).e("avatar"))
                  },
                  [
...
var _sfc_main$P = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("body-bg-image");
    const { getTeekConfigRef } = useTeekConfig();
    const bodyBgImgConfig = getTeekConfigRef("bodyBgImg", {
      imgSrc: void 0,
      imgOpacity: 1,
    ...
    const getStyle = () => {
      ...
      const imgBgVar = ns2.cssVarName("body-bg-img");
      const imgBgOpacityVar = ns2.cssVarName("body-bg-img-opacity");
      const maskBgColorVar = ns2.cssVarName("body-mask-bg-color");
      if (!(imgSrc == null ? void 0 : imgSrc.length)) return { [imgBgVar]: ns2.cssVar("bg-img-default") };
      return {
        [imgBgVar]: `url(${imageSrc.value}) center center / cover no-repeat`,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          unref(bodyBgImgConfig).mask ? (openBlock(), createElementBlock("div", _hoisted_1$r)) : createCommentVNode("v-if", true)
        ],
        6
        /* CLASS, STYLE */
      );
...
const _hoisted_1$q = ["name", "href", "title", "target", "aria-label", "aria-describedby"];
const _hoisted_2$h = { class: "sle" };
var _sfc_main$O = /* @__PURE__ */ defineComponent({
  ...{ name: "FooterGroup" },
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("footer-group");
    const { getTeekConfigRef } = useTeekConfig();
            ...
            renderList(unref(footerGroupConfig), (group, index2) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode(
                  "div",
                  {
                    class: normalizeClass([unref(ns2).e("title"), "flx-center"])
                  },
                  [
                    group.icon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                      key: 0,
                      icon: group.icon,
                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList(group.links || [], (link, idx) => {
                      return openBlock(), createElementBlock(
                        ...
                        {
                          key: (link.name || "") + idx,
                          class: normalizeClass([unref(ns2).e("link")])
                        },
                        [
                          link.icon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                            key: 0,
                            icon: link.icon,
                            style: { "margin-right": "4px" },
                            "aria-hidden": "true"
                          ...
                          createBaseVNode("a", {
                            ...
                            unref(isExternal)(link.link || "") ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                              key: 0,
                              icon: unref(externalLinkIcon),
                              class: normalizeClass(unref(ns2).e("link__external-icon")),
                              "aria-hidden": "true"
                            }, null, 8, ["icon", "class"])) : createCommentVNode("v-if", true)
                          ], 8, _hoisted_1$q)
                        ],
...
const _hoisted_3$d = ["href", "title", "aria-label"];
...
var _sfc_main$N = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("footer-info");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    const footerInfo = getTeekConfigRef("footerInfo", {});
    const social = getTeekConfigRef("social", []);
    const footerData = computed(() => {
      const { theme: theme2 = {}, copyright = {}, icpRecord, securityRecord } = footerInfo.value || {};
      const data = [];
      if (theme2.show !== false) {
        data.push({
          name: "Theme By Teek",
          icon: themeIcon,
    ...
    return (_ctx, _cache) => {
      return unref(footerInfo) || unref(social).length ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: normalizeClass([unref(ns2).b(), unref(ns2).join("wallpaper-outside")]),
        role: "contentinfo",
        "aria-label": unref(t)("tk.footerInfo.label")
      }, [
        unref(social).length ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass(`${unref(ns2).e("icons")} flx-center`),
          role: "group",
        ...
        unref(footerInfo) ? (openBlock(), createElementBlock(
          ...
          [
            ...
            createBaseVNode("div", {
              class: normalizeClass(`${unref(ns2).e("list")} flx-wrap-justify-center`),
              role: "list",
              ...
              (openBlock(true), createElementBlock(
                ...
                renderList(footerData.value, (item) => {
                  return openBlock(), createElementBlock(
                    ...
                    {
                      key: item.name,
                      class: normalizeClass(`${unref(ns2).e("list__item")} flx-align-center`),
                      role: "listitem"
                    },
                    [
                      item.icon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
...
var TkFocusTrap = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render]]);
const _hoisted_1$o = ["src", "crossorigin"];
var _sfc_main$L = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const arrowPrevKls = computed(() => [ns2.e("btn"), ns2.e("prev"), ns2.is("disabled", !props.infinite && isFirst.value)]);
    const arrowNextKls = computed(() => [ns2.e("btn"), ns2.e("next"), ns2.is("disabled", !props.infinite && isLast.value)]);
                ...
                createVNode(unref(TkFocusTrap), {
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode(
                      ...
                      [
                        createVNode(unref(_sfc_main$1n), { icon: unref(closeIcon) }, null, 8, ["icon"])
                      ],
                      2
                      /* CLASS */
                    ),
                    ...
                    !isSingle.value ? (openBlock(), createElementBlock(
                      ...
                      [
                        createBaseVNode(
                          ...
                          [
                            createVNode(unref(_sfc_main$1n), { icon: unref(arrowLeftIcon) }, null, 8, ["icon"])
                          ],
                          2
                          /* CLASS */
                        ),
                        createBaseVNode(
                          ...
                          [
                            createVNode(unref(_sfc_main$1n), { icon: unref(arrowRightIcon) }, null, 8, ["icon"])
                          ],
                          2
                          /* CLASS */
                        )
                    ...
                    _ctx.$slots.progress || __props.showProgress ? (openBlock(), createElementBlock(
                      ...
                      {
                        key: 1,
                        class: normalizeClass([unref(ns2).e("btn"), unref(ns2).e("progress")])
                      },
                      [
                        ...
                        (openBlock(true), createElementBlock(
                          ...
                          renderList(__props.urlList, (url, i) => {
                            return withDirectives((openBlock(), createElementBlock("img", {
                              ...
                              src: url,
                              style: normalizeStyle(imgStyle.value),
                              class: normalizeClass([unref(ns2).e("img"), "image-viewer__img"]),
...
const createImageViewer = (options) => {
  ...
  instance = createVNode(_sfc_main$K, options);
  render$1(instance, container);
};
...
var _sfc_main$I = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(() => {
      var _a;
      const items = (_a = breadcrumb.value) == null ? void 0 : _a.querySelectorAll(`.${ns$2.e("item")}`);
...
var _sfc_main$G = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("article-breadcrumb");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    const { localeIndex, theme: theme2, page } = useData$1();
    ...
    const breadcrumbList = computed(() => {
      ...
      relativePathArrConst.forEach((item, index2) => {
        ...
        if ((index2 !== relativePathArrConst.length - 1 || breadcrumb.value.showCurrentName) && fileName !== localeIndex.value) {
          ...
          classifyList.push({
            fileName,
            url: ((_c = (_b = theme2.value.catalogues) == null ? void 0 : _b.inv[path]) == null ? void 0 : _c.url) || ""
          });
        }
      });
      return classifyList;
...
const _hoisted_3$c = ["title", "aria-label"];
const _hoisted_4$8 = {
  key: 1,
  class: "flx-center"
};
const _hoisted_5$6 = ["title", "aria-label"];
const _hoisted_6$5 = {
  key: 2,
  class: "flx-center"
};
...
var _sfc_main$F = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("article-analyze");
    const { t } = useLocale();
    ...
    const teleportInfo = () => {
      ...
      (_a = targetDom == null ? void 0 : targetDom.parentElement) == null ? void 0 : _a.querySelectorAll(`.${ns2.e("wrapper")}`).forEach((v) => v.remove());
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(`${unref(ns2).b()} flx-justify-between`),
        "aria-label": unref(t)("tk.articleAnalyze.label")
      }, [
        __props.breadcrumb ? (openBlock(), createBlock(unref(_sfc_main$G), { key: 0 })) : createCommentVNode("v-if", true),
        isShowInfo.value ? (openBlock(), createElementBlock(
          "div",
          {
            ...
            ref_key: "baseInfoRef",
            ref: baseInfoRef,
            class: normalizeClass(`${unref(ns2).e("wrapper")} flx-align-center`)
          },
          [
            ...
            unref(docAnalysisConfig).wordCount && pageViewInfo.value.wordCount ? (openBlock(), createElementBlock("div", _hoisted_2$e, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                key: 0,
              ...
              }, toDisplayString(pageViewInfo.value.wordCount), 9, _hoisted_3$c)
            ])) : createCommentVNode("v-if", true),
            unref(docAnalysisConfig).readingTime && pageViewInfo.value.readingTime ? (openBlock(), createElementBlock("div", _hoisted_4$8, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                key: 0,
              ...
              }, toDisplayString(pageViewInfo.value.readingTime), 9, _hoisted_5$6)
            ])) : createCommentVNode("v-if", true),
            usePageView.value ? (openBlock(), createElementBlock("div", _hoisted_6$5, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                key: 0,
                icon: unref(viewIcon)
              }, null, 8, ["icon"])) : createCommentVNode("v-if", true),
              ...
              }, toDisplayString(unref(isGet) ? unref(pagePv) : "Get..."), 9, _hoisted_7$2)
            ])) : createCommentVNode("v-if", true)
          ],
          2
          /* CLASS */
...
var _sfc_main$E = /* @__PURE__ */ defineComponent({
  ...
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("article-share");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          createBaseVNode("button", {
            class: normalizeClass([unref(ns2).e("button"), { copied: unref(copied) }, "flx-center"]),
            ...
            !unref(copied) ? (openBlock(), createElementBlock("div", _hoisted_2$d, [
              createVNode(unref(_sfc_main$1n), {
...
const _hoisted_1$j = ["href", "aria-label"];
const _hoisted_2$c = { key: 1 };
const _hoisted_3$a = ["href", "aria-label"];
var _sfc_main$D = /* @__PURE__ */ defineComponent({
  ...{ name: "ArticleUpdate" },
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("article-update");
    const { t } = useLocale();
    const posts = usePosts();
    const route = useRoute();
    const { frontmatter } = useData$1();
      ...
      return withDirectives((openBlock(), createElementBlock(
        ...
        [
          createBaseVNode(
            "div",
            {
              class: normalizeClass([unref(ns2).e("title"), "flx-align-center"])
            },
            [
              createVNode(unref(_sfc_main$1n), {
              ...
              }, toDisplayString(unref(t)("tk.articleUpdate.label")), 9, _hoisted_1$j)) : (openBlock(), createElementBlock(
                "span",
                _hoisted_2$c,
              ...
              renderList(updatePosts.value, (item, index2) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  createBaseVNode(
                    "span",
                    {
                      class: normalizeClass(unref(ns2).m("num")),
                      "aria-hidden": "true"
                    },
                  ...
                  createBaseVNode(
                    ...
                    [
                      ...
                      ], 8, _hoisted_3$a)) : createCommentVNode("v-if", true),
                      item.date ? (openBlock(), createElementBlock(
                        "span",
                        {
                          key: 1,
                          class: normalizeClass(unref(ns2).em("content", "date"))
                        },
...
var _sfc_main$C = /* @__PURE__ */ defineComponent({
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("article-heading-highlight");
    const handleHighlight = () => {
      ...
      if (!elem) return;
      if (!elem.classList.contains(ns2.b())) {
        elem.classList.add(ns2.b());
      }
      elem.classList.remove(ns2.b());
      setTimeout(() => {
        if (elem) elem.classList.add(ns2.b());
      }, 10);
    };
    const route = useRoute();
    watch(route, async () => {
...
var _sfc_main$B = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const initPageStyle = async () => {
      if (!isClient) return;
      await nextTick();
      const tkLayoutDom = document.querySelector(`.${ns2.join("layout")}`);
      ["default", "card", "card-nav", "segment", "segment-nav"].forEach(
        (item) => tkLayoutDom == null ? void 0 : tkLayoutDom.classList.remove(ns2.join(item))
      );
      tkLayoutDom == null ? void 0 : tkLayoutDom.classList.add(ns2.join(themeConfig.value.pageStyle));
    };
...
var _sfc_main$A = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("article-appreciation");
    const { t } = useLocale();
    const { getTeekConfigRef } = useTeekConfig();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([unref(ns2).b(), unref(ns2).m("aside-bottom")]),
...
const _hoisted_1$h = ["aria-label"];
const _hoisted_2$a = ["innerHTML", "aria-expanded", "aria-controls"];
...
var _sfc_main$z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([unref(ns2).b(), unref(ns2).m("doc-after")]),
        "aria-label": unref(t)("tk.articleAppreciation.label")
      }, [
        docAfterOptions.value.buttonHtml ? (openBlock(), createElementBlock("div", {
          ...
          "aria-controls": `${unref(ns2).e("content")}`
        }, null, 8, _hoisted_2$a)) : docAfterOptions.value.expandTitle || docAfterOptions.value.collapseTitle ? (openBlock(), createElementBlock("button", {
          key: 1,
          ...
          icon.value ? (openBlock(), createBlock(unref(_sfc_main$1n), {
            key: 0,
            class: normalizeClass(unref(ns2).e("button__icon")),
            icon: icon.value,
            size: 16,
            "aria-hidden": "true"
          ...
          }, null, 8, _hoisted_4$7)) : (openBlock(), createElementBlock("span", {
            key: 2,
...
var _sfc_main$y = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const popoverContainerId = ns2.join("popover-container");
    onBeforeMount(() => {
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          (openBlock(), createBlock(Teleport, {
            ...
            createVNode(Transition, {
              name: __props.transition ? __props.transitionName || unref(ns2).join("fade-linear") : ""
            }, {
              default: withCtx(() => [
                !__props.disabled ? withDirectives((openBlock(), createElementBlock(
                  "div",
                  {
                    ...
                    class: normalizeClass([unref(ns2).b(), __props.popperClass]),
...
const _hoisted_1$g = ["aria-label"];
const _hoisted_2$9 = ["innerHTML", "aria-expanded", "aria-controls"];
const _hoisted_3$7 = ["aria-expanded", "aria-controls"];
        ...
        createVNode(unref(_sfc_main$y), {
          ...
          reference: withCtx(() => [
            docAfterPopperOptions.value.buttonHtml ? (openBlock(), createElementBlock("div", {
              ...
              "aria-expanded": showContent.value,
              "aria-controls": `${unref(ns2).e("content")}`
            }, null, 8, _hoisted_2$9)) : docAfterPopperOptions.value.title ? (openBlock(), createElementBlock("button", {
              key: 1,
              class: normalizeClass(unref(ns2).e("button")),
              "aria-expanded": showContent.value,
              "aria-controls": `${unref(ns2).e("content")}`,
          ...
          default: withCtx(() => [
            createBaseVNode("div", {
              class: normalizeClass([unref(ns2).e("content"), unref(ns2).m("doc-after-popper")]),
              "aria-label": unref(t)("tk.articleAppreciation.contentLabel")
            }, [
              createBaseVNode("div", {
                class: normalizeClass(unref(ns2).e("content")),
...
const _hoisted_1$f = ["href", "integrity"];
var _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...{ name: "CommentTwikoo" },
  __name: "index",
  setup(__props) {
    ...
    const initCss = () => {
      fetch(cssLink.replace("{version}", version)).then((response) => {
        ...
        style.type = "text/css";
        style.id = "twikoo-css";
        style.textContent = `.${ns2.b("twikoo")} {${data}}`;
    ...
    onMounted(() => {
      initJs();
      initCss();
      twikooJs.value && vpRouter.bindAfterRouteChange(ns2.join("twikoo"), (href) => reloadTwikoo(href));
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass(unref(ns2).b("twikoo"))
        },
        [
  ...
  setup(__props) {
    ...
    onMounted(() => {
      if (!initArtalkByInject() && server) {
        initJs();
        return artalk.value && vpRouter.bindAfterRouteChange(ns2.join("artalk"), () => reloadArtalk());
      }
      console.error(
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass(unref(ns2).b("artalk"))
        },
        [
...
var _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      reloadGiscus();
      vpRouter.bindAfterRouteChange(ns2.join("giscus"), () => {
        reloadGiscus();
      });
    });
    return (_ctx, _cache) => {
      return isShow.value ? (openBlock(), createElementBlock(
        ...
        {
          key: 0,
          class: normalizeClass(unref(ns2).b("giscus"))
        },
        [
...
const _hoisted_1$d = ["href", "integrity"];
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      if (!initWalineByInject() && serverURL && jsLink) {
        ...
        preventJump();
        return vpRouter.bindAfterRouteChange(ns2.join("waline"), () => waline == null ? void 0 : waline.update());
      }
      console.error(
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass(unref(ns2).b("waline"))
        },
        [
  ...
  setup(__props) {
    ...
    watch(
      ...
      (newVal) => {
        ...
        document.documentElement.setAttribute(documentAttribute, ns2.namespace);
        if (langTextTransform) {
          document.documentElement.style.setProperty(ns2.cssVarName("code-block-lang-transform"), langTextTransform);
        }
    ...
    const initCodeBlock = () => {
      ...
      Array.from(modes).forEach((item) => {
        ...
        if ((className == null ? void 0 : className.includes("details")) || (className == null ? void 0 : className.includes(ns2.join("vp-code")))) return;
    ...
    const addClickEvent = (arrowDom, codeDom) => {
      ...
      const codeBlockState = {
        ...
        fold: {
          height: codeBlockConfig.value.overlay ? addUnit(codeBlockConfig.value.overlayHeight) ?? "400px" : ns2.cssVar("code-block-fold-height"),
...
const ns$1 = useNamespace("right-bottom-button");
const _hoisted_1$c = ["title", "aria-label", "aria-valuenow"];
const _hoisted_2$8 = {
  key: 0,
  class: "content"
};
        ...
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default", {
            ...
            withDirectives(createBaseVNode("div", {
              ...
              class: normalizeClass([unref(ns$1).e("button"), "back-top"]),
              onClick: _cache[0] || (_cache[0] = //@ts-ignore
              (...args) => unref(scrollToTop) && unref(scrollToTop)(...args)),
              style: normalizeStyle({ [unref(ns$1).cssVarName("progress")]: progress.value }),
              role: "button",
              ...
              unref(backTopConfig).content === "progress" ? (openBlock(), createElementBlock(
                ...
                1
                /* TEXT */
              )) : unref(backTopConfig).content === "icon" ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                key: 1,
                icon: unref(rocketIcon),
                "aria-hidden": "true"
              }, null, 8, ["icon"])) : createCommentVNode("v-if", true)
...
const _hoisted_1$b = ["title", "aria-label"];
var _sfc_main$p = /* @__PURE__ */ defineComponent({
  ...{ name: "ToComment" },
  __name: "ToComment",
  setup(__props) {
    ...
    const scrollToComment = useDebounce(
      () => {
        var _a;
        if (!isClient) return;
        (_a = document.querySelector(`#${ns$1.join("comment")}`)) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
        setTimeout(() => {
          var _a2, _b;
        ...
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default", {
            ...
            withDirectives(createBaseVNode("div", {
              ...
              class: normalizeClass(unref(ns$1).e("button")),
              onClick: _cache[0] || (_cache[0] = //@ts-ignore
...
const useThemeColorList = () => {
  ...
  return computed(() => {
    ...
    const useVitepressTheme = isBoolean$1(customize) ? customize === false : (customize == null ? void 0 : customize.vitepressTheme) ?? true;
    const useElementPlusTheme = isBoolean$1(customize) ? customize === false : (customize == null ? void 0 : customize.elementPlusTheme) ?? true;
...
const _hoisted_2$7 = ["onClick", "title", "aria-label"];
var _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...{ name: "ThemeColor" },
  __name: "ThemeColor",
  setup(__props) {
    ...
    const themeColorName = useStorage(
      ...
      ((_a = themeEnhanceConfig.value.themeColor) == null ? void 0 : _a.defaultColorName) || ThemeColorName.vpDefault
    );
    ...
    const update = (val) => {
      ...
      if (themeColorList.includes(val)) {
        ...
        const appendThemeColor = ((_a2 = themeEnhanceConfig.value.themeColor) == null ? void 0 : _a2.append) || [];
        const option = appendThemeColor.map((item) => item.options).flat().filter((item) => item.value === val);
        const color = (_b = option[0]) == null ? void 0 : _b.color;
        !color && clear();
        primaryColor.value = color || getComputedStyle(el).getPropertyValue(varNameList.vpBrand1);
      }
      (_d = (_c = themeEnhanceConfig.value.themeColor) == null ? void 0 : _c.switchColorDone) == null ? void 0 : _d.call(_c, val);
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$y), {
        class: normalizeClass(unref(ns$1).e("button")),
        "popper-class": unref(ns$1).e("dropdown"),
        placement: "left-start",
        width: 120,
        "x-offset": 15,
        "transition-name": unref(ns$1).join("fade-scale"),
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(unref(themeColorSelectList), (item) => {
              return openBlock(), createElementBlock("ul", {
                ...
                createBaseVNode("li", {
                  class: normalizeClass(`${unref(ns$1).e("dropdown__title")} sle`),
                  title: item.tip,
                  "aria-label": item.label
                }, toDisplayString(item.label), 11, _hoisted_1$a),
                  ...
                  createBaseVNode("ul", null, [
                    (openBlock(true), createElementBlock(
                      ...
                      renderList(item.options, (option) => {
                        ...
                        }, toDisplayString(option.label), 11, _hoisted_2$7);
                      }),
                      128
                      /* KEYED_FRAGMENT */
                    ))
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns$1).b(), unref(ns$1).join("wallpaper-outside"), "flx-column"])
        },
        [
          renderSlot(_ctx.$slots, "teek-right-bottom-before"),
          unref(backTopConfig).enabled ? (openBlock(), createBlock(_sfc_main$q, { key: 0 }, {
          ...
          unref(toCommentConfig).enabled && (commentConfig.value.enabled || commentConfig.value.provider) ? (openBlock(), createBlock(_sfc_main$p, { key: 1 }, {
            default: withCtx((scope) => [
          ...
          !disabledThemeColor.value ? (openBlock(), createBlock(_sfc_main$o, { key: 2 })) : createCommentVNode("v-if", true),
...
const _hoisted_4$5 = { class: "flx-align-center" };
const _hoisted_5$3 = {
  id: "notice-title",
  class: "title sle"
};
...
var _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const styleObj = computed(() => {
      ...
      return noticeStyle.trim().startsWith(`.${ns2.b()}`) ? noticeStyle : `.${ns2.b()} { ${noticeStyle} }`;
    });
    ...
    const storageKey = computed(() => ns2.storageKey("notice", localeIndex.value, isClient ? window.location.hostname : ""));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        !destroyNoticeIcon.value ? withDirectives((openBlock(), createElementBlock("div", {
          key: 1,
          class: normalizeClass([unref(ns2).e("icon"), { twinkle: unref(noticeConfig).twinkle }, "flx"]),
        ...
        withDirectives(createBaseVNode(
          "div",
          {
            class: normalizeClass([unref(ns2).e("popover"), unref(ns2).is(unref(noticeConfig).position)]),
          ...
          [
            renderSlot(_ctx.$slots, "header", {}, () => [
              createBaseVNode("div", {
                class: normalizeClass([unref(ns2).e("popover__header"), "flx-justify-between"]),
                ...
                createVNode(unref(_sfc_main$1n), {
                  ...
                  color: "#ffffff",
                  size: "20px",
                  class: normalizeClass(unref(ns2).join("pointer")),
            ...
            createBaseVNode("div", {
              class: normalizeClass(unref(ns2).e("popover__content")),
...
const _hoisted_1$8 = ["title", "disabled"];
const _hoisted_2$5 = ["value", "name", "disabled", "checked", "aria-checked"];
...
var _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(__props) {
    const ns2 = useNamespace("segmented-item");
    const model = useModel(__props, "modelValue");
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("label", {
        class: normalizeClass([unref(ns2).b(), unref(ns2).is("active", model.value === __props.value && !__props.disabled), unref(ns2).is("disabled", __props.disabled)]),
        title: __props.title,
        ...
        createBaseVNode(
          ...
          [
            __props.icon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
              key: 0,
              icon: __props.icon,
              "aria-hidden": "true"
            }, null, 8, ["icon"])) : createCommentVNode("v-if", true),
...
var _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("border-highlight");
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns2).b(), unref(ns2).is("active", Boolean(__props.active))])
        },
        [
          renderSlot(_ctx.$slots, "default")
        ],
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode(
          ...
          [
            ...
            __props.helper ? (openBlock(), createBlock(_sfc_main$i, {
              key: 0,
                        ...
                        return openBlock(), createElementBlock(
                          ...
                          [
                            createBaseVNode("div", _hoisted_1$6, [
                              tip.icon ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                                key: 0,
                                icon: tip.icon,
                                size: 16,
                                style: { "margin-right": "4px" }
        ...
        __props.borderHighlight ? (openBlock(), createBlock(_sfc_main$h, {
          key: 0,
...
const _hoisted_1$5 = ["name", "min", "max", "disabled", "step"];
var _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...{ name: "InputSlide" },
  __name: "index",
  props: /* @__PURE__ */ mergeModels({
  ...
  emits: ["update:modelValue"],
  setup(__props) {
    const ns2 = useNamespace("input-slide");
    ...
    const sliderValueVar = ns2.cssVarName("slider-value");
    const sliderMinVar = ns2.cssVarName("slider-min");
    const sliderMaxVar = ns2.cssVarName("slider-max");
          ...
          createBaseVNode(
            ...
            [
              withDirectives(createBaseVNode("input", {
                ...
                disabled: __props.disabled,
                step: __props.step,
                class: normalizeClass([unref(ns2).e("label__input"), unref(ns2).e("label__input-progress"), unref(ns2).is("disabled", __props.disabled)])
                ...
                default: withCtx(() => [
                  withDirectives(createBaseVNode(
                    "span",
                    {
                      ...
                      class: normalizeClass([unref(ns2).e("label__tooltip"), unref(ns2).is("opacity-0", unref(hovering) && positioning.value)])
                    },
...
const _hoisted_1$4 = { class: "flx-justify-between flx-1" };
const _hoisted_2$3 = { class: "flx-align-center" };
...
const _hoisted_6$1 = ["onClick", "title", "aria-label"];
var _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...{ name: "ThemeColor" },
  __name: "ThemeColor",
  setup(__props) {
    ...
    const update = (val) => {
      ...
      if (themeColorList.includes(val)) {
        ...
        const appendThemeColor = ((_a2 = themeEnhanceConfig.value.themeColor) == null ? void 0 : _a2.append) || [];
        const option = appendThemeColor.map((item) => item.options).flat().filter((item) => item.value === val);
        const color = (_b2 = option[0]) == null ? void 0 : _b2.color;
        !color && clear();
        primaryColor.value = color || getComputedStyle(el).getPropertyValue(varNameList.vpBrand1);
      }
      (_d = (_c = themeEnhanceConfig.value.themeColor) == null ? void 0 : _c.switchColorDone) == null ? void 0 : _d.call(_c, val);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          unref(spotlight) && !unref(supportTouch) ? (openBlock(), createBlock(_sfc_main$9, {
            key: 0,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, { name: unref(transitionName) }, {
        default: withCtx(() => {
          var _a2;
          return [
            unref(spotlightToggledOn) ? (openBlock(), createBlock(_sfc_main$g, {
              key: 0,
              icon: unref(clickIcon),
...
var _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !unref(isMobile) && unref(themeEnhanceConfig).position === "top" ? (openBlock(), createBlock(unref(_sfc_main$y), {
        key: 0,
        ...
        default: withCtx(() => [
          createBaseVNode(
            ...
            [
              ...
              !disabledList.value.themeColor ? (openBlock(), createBlock(_sfc_main$a, { key: 1 })) : createCommentVNode("v-if", true),
...
var _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const ns2 = useNamespace("vp-container");
    const slots = useSlots();
    ...
    return (_ctx, _cache) => {
      return hasTitle.value || hasText.value ? (openBlock(), createElementBlock(
        ...
        {
          key: 0,
          class: normalizeClass([unref(ns2).b(), "vp-doc"])
        },
        [
          createBaseVNode(
            "div",
            ...
            [
              hasTitle.value ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
                renderSlot(_ctx.$slots, "title", {}, () => [
                  createBaseVNode("span", { innerHTML: __props.title }, null, 8, _hoisted_2$2)
                ])
              ])) : createCommentVNode("v-if", true),
              hasText.value ? (openBlock(), createElementBlock("p", _hoisted_3$2, [
                renderSlot(_ctx.$slots, "default", {}, () => [
                  createBaseVNode("span", { innerHTML: __props.text }, null, 8, _hoisted_4$2)
                ])
              ])) : createCommentVNode("v-if", true)
            ],
            2
...
const _hoisted_1$2 = ["title", "aria-label"];
var _sfc_main$4 = /* @__PURE__ */ defineComponent({
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("sidebar-trigger");
    const { t } = useLocale();
    const active2 = ref(false);
    const isLt960 = useMediaQuery("(max-width: 960px)");
    const toggleSideBar = () => {
      const layoutDom = document.querySelector(`.${ns2.join("layout")}`);
      layoutDom && layoutDom.classList.toggle(ns2.is("sidebar-collapse"));
      if (!active2.value) {
        active2.value = true;
        setTimeout(() => {
          active2.value = false;
    ...
    return (_ctx, _cache) => {
      return !unref(isLt960) ? renderSlot(_ctx.$slots, "default", {
        ...
        createBaseVNode("div", {
          class: normalizeClass([unref(ns2).b(), unref(ns2).is("active", active2.value)]),
          ...
          createBaseVNode(
            "div",
            {
              class: normalizeClass([unref(ns2).join("right-bottom-button__button")])
            },
            [
              createVNode(unref(_sfc_main$1n), {
                icon: unref(autoWidthIcon),
...
var _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "index",
  setup(__props) {
    const ns2 = useNamespace("home-features");
    const { getTeekConfigRef } = useTeekConfig();
    const featuresConfig = getTeekConfigRef("features", []);
    ...
    return (_ctx, _cache) => {
      var _a;
      return ((_a = unref(featuresConfig)) == null ? void 0 : _a.length) ? (openBlock(), createElementBlock(
        "div",
        {
          key: 0,
          class: normalizeClass([unref(ns2).b(), "vp-doc"])
              ...
              return openBlock(), createElementBlock(
                ...
                [
                  feature.features ? (openBlock(), createElementBlock(
                    ...
                    {
                      key: 0,
                      class: normalizeClass([unref(ns2).e("feature-wrapper"), "features-wrapper"])
                    },
                    [
                      createBaseVNode(
                        "div",
                        {
                          class: normalizeClass(unref(ns2).e("feature__content"))
                        },
                        [
                          createBaseVNode("img", {
                            src: feature.image,
                          ...
                          createBaseVNode(
                            "div",
                            {
                              class: normalizeClass([unref(ns2).e("feature__header"), "header"])
                            },
                            [
                              createBaseVNode("h2", {
                                ref_for: true,
                          ...
                          ((_a2 = feature.features) == null ? void 0 : _a2.length) ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
                            (openBlock(true), createElementBlock(
                              Fragment,
                              null,
                    ...
                    {
                      key: 1,
                      class: normalizeClass([unref(ns2).e("highlight-wrapper"), "features-wrapper"])
                    },
                    [
                      createBaseVNode(
                        "div",
                        {
                          class: normalizeClass(unref(ns2).e("highlight"))
                        },
                        [
                          createBaseVNode("img", {
                            src: feature.image,
                          ...
                          createBaseVNode(
                            "div",
                            {
                              class: normalizeClass(unref(ns2).e("highlight__content"))
                            },
                            [
                              createBaseVNode(
                                "div",
                                {
                                  class: normalizeClass([unref(ns2).e("highlight__header"), "header"])
                                },
                                [
                                  createBaseVNode("h2", {
                                    ref_for: true,
                              ...
                              ((_b = feature.highlights) == null ? void 0 : _b.length) ? (openBlock(), createElementBlock("div", _hoisted_10, [
                                (openBlock(true), createElementBlock(
                                  Fragment,
                                  null,
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const ns2 = useNamespace("route-loading");
    const vpRouter = useVpRouter();
    const { getTeekConfigRef } = useTeekConfig();
                ...
                withDirectives(createBaseVNode(
                  ...
                  [
                    createBaseVNode(
                      "div",
                      {
                        class: normalizeClass(unref(ns2).e("loader"))
                      },
                      [
                        createBaseVNode(
                          "div",
                          {
                            class: normalizeClass(unref(ns2).e("spinner"))
                          },
                          null,
                          2
                          /* CLASS */
...
var _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const loaded = ref(false);
    const ns2 = useNamespace("article-banner");
    const { frontmatter } = useData$1();
    const route = useRoute();
    ...
    const style = computed(() => {
      return {
        [ns2.cssVarName("article-banner-bg-color")]: frontmatter.value.coverBgColor || articleBannerConfig.value.defaultCoverBgColor
      };
    });
    watch(
      () => route.path,
      ...
      return !unref(hasSidebar) && unref(articleBannerConfig).enabled ? withDirectives((openBlock(), createElementBlock(
        ...
        [
          createBaseVNode(
            "div",
            {
              class: normalizeClass([unref(ns2).e("wrapper"), "flx-justify-center"])
            },
            [
              imgSrc.value ? (openBlock(), createElementBlock(
                ...
                {
                  key: 0,
                  class: normalizeClass(unref(ns2).e("cover"))
                },
                [
                  createBaseVNode("img", {
                    src: imgSrc.value,
              ...
              createBaseVNode(
                ...
                [
                  ...
                  !unref(isMobile) ? (openBlock(), createBlock(unref(_sfc_main$G), { key: 0 })) : createCommentVNode("v-if", true),
                  createBaseVNode(
                    "div",
                    {
                      class: normalizeClass([unref(ns2).e("meta"), "flx-center flx-wrap"])
                    },
                    [
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { frontmatter, localeIndex, page } = useData$1();
    const { hasSidebar } = useSidebar();
    const teekConfig = getTeekConfigRef(null, {
      teekTheme: true,
      teekHome: true,
    ...
    const themeSizeAttribute = ns2.join("theme-size");
    watch(
      ...
      return unref(teekConfig).teekTheme ? (openBlock(), createElementBlock(
        ...
        [
          ...
          unref(frontmatter).layout !== false ? (openBlock(), createElementBlock(
            ...
            { key: 3 },
            [
              ((_a = unref(teekConfig).bodyBgImg) == null ? void 0 : _a.imgSrc) ? (openBlock(), createBlock(unref(_sfc_main$P), { key: 0 })) : createCommentVNode("v-if", true),
          ...
          withDirectives(createVNode(unref(Layout2), {
            class: normalizeClass([
              unref(ns2).b(),
              { [unref(ns2).m("hide-vp-home")]: !unref(teekConfig).vpHome },
              unref(ns2).has("sidebar-trigger", unref(teekConfig).sidebarTrigger)
            ])
          }, createSlots({
            "home-hero-before": withCtx(() => [
            ...
            "doc-before": withCtx(() => [
              ...
              unref(teekConfig).sidebarTrigger ? (openBlock(), createBlock(unref(_sfc_main$4), { key: 3 }, {
                default: withCtx((scope) => [
              ...
              return [
                ...
                ["doc-after", "doc-after-popper"].includes(unref(teekConfig).appreciation.position) ? (openBlock(), createElementBlock(
                  ...
                  [
                    ...
                    unref(teekConfig).appreciation.position === "doc-after" ? (openBlock(), createBlock(unref(_sfc_main$z), { key: 0 })) : unref(teekConfig).appreciation.position === "doc-after-popper" ? (openBlock(), createBlock(unref(_sfc_main$x), { key: 1 })) : createCommentVNode("v-if", true),
                ...
                commentConfig.value.enabled && commentConfig.value.provider ? (openBlock(), createElementBlock(
                  ...
                  [
                    ...
                    commentConfig.value.provider === "render" ? renderSlot(_ctx.$slots, "teek-comment", { key: 0 }) : (openBlock(), createBlock(resolveDynamicComponent((_a2 = commentConfig.value.components) == null ? void 0 : _a2[commentConfig.value.provider]), {
                      key: 1,
                      id: `${unref(ns2).namespace}-comment`,
                      class: normalizeClass(unref(ns2).e("comment"))
                    }, null, 8, ["id", "class"])),
              ...
              unref(isArchivesPage) || unref(isCataloguePage) || unref(isArticleOverviewPage) ? (openBlock(), createElementBlock(
                ...
                [
                  ...
                  unref(isArchivesPage) ? (openBlock(), createBlock(
                    ...
                    1024
                    /* DYNAMIC_SLOTS */
                  )) : unref(isArticleOverviewPage) ? (openBlock(), createBlock(unref(_sfc_main$1s), { key: 2 })) : createCommentVNode("v-if", true),
...
var index = {
  ...
  async enhanceApp({ app, siteData, router }) {
    app.component("TkCataloguePage", _sfc_main$1v);
    app.component("TkArchivesPage", _sfc_main$1t);
    app.component("TkArticleOverviewPage", _sfc_main$1s);
    app.component("TkLoginPage", _sfc_main$1k);
    app.component("TkRiskLinkPage", _sfc_main$1j);
    app.component("TkDemoCode", _sfc_main$1h);
    app.component("TkTitleTag", _sfc_main$1x);
    app.component("TkIcon", _sfc_main$1n);
    if (!isClient) return;
